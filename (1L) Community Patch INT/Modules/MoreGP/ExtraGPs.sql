...
--
	('TXT_KEY_GREAT_WORK_MW_010', '델포이 찬가'),
	('TXT_KEY_GREAT_WORK_MW_020', '멜로디에 관한 틀'),
	('TXT_KEY_GREAT_WORK_MW_030', '팔레스타인의 노래'),
	('TXT_KEY_GREAT_WORK_MW_040', '킹 아더'),
	('TXT_KEY_GREAT_WORK_MW_050', '예레미아의 애가'),
	('TXT_KEY_GREAT_WORK_MW_060', '새 조각상처럼 은혜로우시네'),
	('TXT_KEY_GREAT_WORK_MW_070', '체리 라이프'),
	('TXT_KEY_GREAT_WORK_MW_080', '한여름 밤의 꿈'),
	('TXT_KEY_GREAT_WORK_MW_090', '람메르무어의 루치아'),
	('TXT_KEY_GREAT_WORK_MW_100', '나는 눈 덮인 언덕을 떠났다'),
	('TXT_KEY_GREAT_WORK_MW_110', '초원의 경마'),
	('TXT_KEY_GREAT_WORK_MW_120', '러라인'),
	('TXT_KEY_GREAT_WORK_MW_130', '아라비아 기상곡'),
	('TXT_KEY_GREAT_WORK_MW_140', '진혼곡'),
	('TXT_KEY_GREAT_WORK_MW_150', '파란 하늘'),
	('TXT_KEY_GREAT_WORK_MW_160', '지크라야티'),
	('TXT_KEY_GREAT_WORK_MW_170', '카르미나 부라나'),
	('TXT_KEY_GREAT_WORK_MW_180', '현을 위한 아다지오'),
	('TXT_KEY_GREAT_WORK_MW_190', '피터와 늑대'),
	('TXT_KEY_GREAT_WORK_MW_200', '나의 세레나데'),
	('TXT_KEY_GREAT_WORK_MW_210', '그땐 미처 알지 못했지'),
	('TXT_KEY_GREAT_WORK_MW_220', '루 아프자'),
	('TXT_KEY_GREAT_WORK_MW_230', '장밋빛 인생'),
	('TXT_KEY_GREAT_WORK_MW_240', '협주곡 3번 ''퀘벡 협주곡'''),
	('TXT_KEY_GREAT_WORK_MW_250', '결혼 이야기'),
	('TXT_KEY_GREAT_WORK_MW_260', '분위기에서'),
	('TXT_KEY_GREAT_WORK_MW_270', '신비적인'),
	('TXT_KEY_GREAT_WORK_MW_280', '포인시아나'),
	('TXT_KEY_GREAT_WORK_MW_290', '하트브레이크 호텔'),
	('TXT_KEY_GREAT_WORK_MW_300', '팬터지'),
	('TXT_KEY_GREAT_WORK_MW_310', '스탠드 바이 미'),
	('TXT_KEY_GREAT_WORK_MW_320', '당신의 사랑스러운 달콤한 얼굴에'),
	('TXT_KEY_GREAT_WORK_MW_330', '과히라와 탐보'),
	('TXT_KEY_GREAT_WORK_MW_340', '이파네마에서 온 소녀'),
	('TXT_KEY_GREAT_WORK_MW_350', '변화가 오리란 걸 알아요'),
	('TXT_KEY_GREAT_WORK_MW_360', '라이크 어 롤링스톤'),
	('TXT_KEY_GREAT_WORK_MW_370', '라 보엠'),
	('TXT_KEY_GREAT_WORK_MW_380', '하느님만 아시네'),
	('TXT_KEY_GREAT_WORK_MW_390', '엔다로 마하누바불루'),
	('TXT_KEY_GREAT_WORK_MW_400', '서머타임'),
	('TXT_KEY_GREAT_WORK_MW_410', '라이프 온 마스'),
	('TXT_KEY_GREAT_WORK_MW_420', '네게는 친구가 있잖아'),
	('TXT_KEY_GREAT_WORK_MW_430', '질투심 많은 사람'),
	('TXT_KEY_GREAT_WORK_MW_440', '킹키 레게'),
	('TXT_KEY_GREAT_WORK_MW_450', '미신'),
	('TXT_KEY_GREAT_WORK_MW_460', '더 페이백'),
	('TXT_KEY_GREAT_WORK_MW_470', '워터 노 겟 에너미'),
	('TXT_KEY_GREAT_WORK_MW_480', '보혜미안의 광상곡'),
	('TXT_KEY_GREAT_WORK_MW_490', '자유'),
	('TXT_KEY_GREAT_WORK_MW_500', '산소'),
	('TXT_KEY_GREAT_WORK_MW_510', '당신의 사랑이 얼마나 깊은지'),
	('TXT_KEY_GREAT_WORK_MW_520', '거울 속의 거울'),
	('TXT_KEY_GREAT_WORK_MW_530', '처크의 사랑'),
	('TXT_KEY_GREAT_WORK_MW_540', '정말 무서울 거야'),
	('TXT_KEY_GREAT_WORK_MW_550', '티어드롭'),
	('TXT_KEY_GREAT_WORK_MW_560', '베이비 캔 아이 홀드 유'),
	('TXT_KEY_GREAT_WORK_MW_570', '섀도우'),
	('TXT_KEY_GREAT_WORK_MW_580', '스멜 라이크 틴 스피릿'),
	('TXT_KEY_GREAT_WORK_MW_590', '돈 크라이 포 미 아르헨티나'),
	('TXT_KEY_GREAT_WORK_MW_600', '대서양'),
	('TXT_KEY_GREAT_WORK_MW_610', '썸웨어 오버더 레인보우'),
	('TXT_KEY_GREAT_WORK_MW_620', '사운드 오브 다 폴리스'),
	('TXT_KEY_GREAT_WORK_MW_630', '팔라디오'),
	('TXT_KEY_GREAT_WORK_MW_640', 'M12 은하수'),	
	('TXT_KEY_GREAT_WORK_MW_650', '알멘드라'),
	('TXT_KEY_GREAT_WORK_MW_660', '피아노 협주곡 ''메모 플로라'''),
	('TXT_KEY_GREAT_WORK_MW_670', '잃어버린 자'),
	('TXT_KEY_GREAT_WORK_MW_680', '인 더 무드 포 러브'),
	('TXT_KEY_GREAT_WORK_MW_690', '상상화'),
	('TXT_KEY_GREAT_WORK_MW_700', '리버 플로우 인 유'),
	('TXT_KEY_GREAT_WORK_MW_710', '11월'),
	('TXT_KEY_GREAT_WORK_MW_720', '바바 예투'),
	('TXT_KEY_GREAT_WORK_MW_730', '드루메 네그리타'),
	('TXT_KEY_GREAT_WORK_MW_740', '나'),
	('TXT_KEY_GREAT_WORK_MW_750', '그리고 이것'),
	('TXT_KEY_GREAT_WORK_MW_760', '강남 스타일'),
	('TXT_KEY_GREAT_WORK_MW_770', '야상곡 바단조'),
	('TXT_KEY_GREAT_WORK_MW_780', '난 내 이름을 몰라'),
	('TXT_KEY_GREAT_WORK_MW_790', '북극을 위한 비가'),
	('TXT_KEY_GREAT_WORK_MW_800', '정글'),
	('TXT_KEY_GREAT_WORK_MW_810', '그래 릴리'),
	('TXT_KEY_GREAT_WORK_MW_820', '데스파시토'),
	('TXT_KEY_GREAT_WORK_MW_830', '롱 라지'),
	('TXT_KEY_GREAT_WORK_MW_840', '캡틴'),
	('TXT_KEY_GREAT_WORK_MW_850', '비구름'),
	('TXT_KEY_GREAT_WORK_MW_860', '블라인딩 라이츠'),
	('TXT_KEY_GREAT_WORK_MW_870', '아이 띵크 오브 유'),
	('TXT_KEY_GREAT_WORK_MW_880', '소스'),
	('TXT_KEY_GREAT_WORK_MW_890', '네나'),
	('TXT_KEY_GREAT_WORK_MW_900', '블룸');
...
--
	('TXT_KEY_GREAT_WORK_WW_010', '길가메시 서사시'),
	('TXT_KEY_GREAT_WORK_WW_020', '아프로디테의 송가'),
	('TXT_KEY_GREAT_WORK_WW_030', '원초 연대기'),
	('TXT_KEY_GREAT_WORK_WW_040', '디완'),
	('TXT_KEY_GREAT_WORK_WW_050', '신 에더'),
	('TXT_KEY_GREAT_WORK_WW_060', '케브라 나가스트'),
	('TXT_KEY_GREAT_WORK_WW_070', '무깟디마'),
	('TXT_KEY_GREAT_WORK_WW_080', '릴라'),
	('TXT_KEY_GREAT_WORK_WW_090', '몽골비사'),
	('TXT_KEY_GREAT_WORK_WW_100', '고킨와카슈'),
	('TXT_KEY_GREAT_WORK_WW_110', '마저리 켐프 서'),
	('TXT_KEY_GREAT_WORK_WW_120', '고린노쇼'),
	('TXT_KEY_GREAT_WORK_WW_130', '알라딘과 요술 램프'),
	('TXT_KEY_GREAT_WORK_WW_140', '여인들의 도시의 서'),
	('TXT_KEY_GREAT_WORK_WW_150', '더 블레이징 월드'),
	('TXT_KEY_GREAT_WORK_WW_160', '라임 디 마돈나'),
	('TXT_KEY_GREAT_WORK_WW_170', '서유기'),
	('TXT_KEY_GREAT_WORK_WW_180', '피터래빗'),
	('TXT_KEY_GREAT_WORK_WW_190', '나이팅게일에 부치는 노래'),
	('TXT_KEY_GREAT_WORK_WW_200', '눈의 여왕'),
	('TXT_KEY_GREAT_WORK_WW_210', '라일락'),
	('TXT_KEY_GREAT_WORK_WW_220', '칼레발라'),
	('TXT_KEY_GREAT_WORK_WW_230', '크툴루의 부름'),
	('TXT_KEY_GREAT_WORK_WW_240', '호빗'),
	('TXT_KEY_GREAT_WORK_WW_250', '틴틴의 모험'),
	('TXT_KEY_GREAT_WORK_WW_260', '빨간 머리 앤'),
	('TXT_KEY_GREAT_WORK_WW_270', '메리 포핀스'),
	('TXT_KEY_GREAT_WORK_WW_280', '영국의 아스테릭스'),
	('TXT_KEY_GREAT_WORK_WW_290', '제국의 종말'),
	('TXT_KEY_GREAT_WORK_WW_300', '자기만의 방'),
	('TXT_KEY_GREAT_WORK_WW_310', '머트와 제프'),
	('TXT_KEY_GREAT_WORK_WW_320', '솔라리스'),
	('TXT_KEY_GREAT_WORK_WW_330', '녹턴'),
	('TXT_KEY_GREAT_WORK_WW_340', '삶과 운명'),
	('TXT_KEY_GREAT_WORK_WW_350', '미국의 아들의 기록'),
	('TXT_KEY_GREAT_WORK_WW_360', '포우나무, 포우나무'),
	('TXT_KEY_GREAT_WORK_WW_370', '가프'),
	('TXT_KEY_GREAT_WORK_WW_380', '런어라운드'),
	('TXT_KEY_GREAT_WORK_WW_390', '하드리아누스 황제의 회고록'),
	('TXT_KEY_GREAT_WORK_WW_400', '모든 것이 산산이 부서지다'),
	('TXT_KEY_GREAT_WORK_WW_410', '연인'),
	('TXT_KEY_GREAT_WORK_WW_420', '버섯'),
	('TXT_KEY_GREAT_WORK_WW_430', '아스트로 보이'),
	('TXT_KEY_GREAT_WORK_WW_440', '솔로몬의 노래'),
	('TXT_KEY_GREAT_WORK_WW_450', '더 위처'),
	('TXT_KEY_GREAT_WORK_WW_460', '해리 포터와 마법사의 돌'),
	('TXT_KEY_GREAT_WORK_WW_470', '시녀이야기'),
	('TXT_KEY_GREAT_WORK_WW_480', '영혼의 집'),
	('TXT_KEY_GREAT_WORK_WW_490', '작은 것들의 신'),
	('TXT_KEY_GREAT_WORK_WW_500', '껌둥이들의 책'),
	('TXT_KEY_GREAT_WORK_WW_510', '몽키비치'),
	('TXT_KEY_GREAT_WORK_WW_520', '푸른 초원, 흐르는 강물'),
	('TXT_KEY_GREAT_WORK_WW_530', '연금술사'),
	('TXT_KEY_GREAT_WORK_WW_540', '진정한 영광은 여기에 있다'),
--
...
--
	('TXT_KEY_GREAT_WORK_AW_010', '여신 다이아나의 그림을 그리는 타미리스'),
	('TXT_KEY_GREAT_WORK_AW_020', '테오티우아칸의 위대한 여신'),
	('TXT_KEY_GREAT_WORK_AW_030', '프란체스코 데스테의 초상'),
	('TXT_KEY_GREAT_WORK_AW_040', '쾌락의 정원'),
	('TXT_KEY_GREAT_WORK_AW_050', '보현보살'),
	('TXT_KEY_GREAT_WORK_AW_060', '모견도'),
	('TXT_KEY_GREAT_WORK_AW_070', '자화상'),
	('TXT_KEY_GREAT_WORK_AW_080', '푸른 드레스를 입은 마르가리타 공주'),
	('TXT_KEY_GREAT_WORK_AW_090', '금강전도'),
	('TXT_KEY_GREAT_WORK_AW_100', '강풍 속의 네덜란드 선박'),
	('TXT_KEY_GREAT_WORK_AW_110', '상춘야흥'),
	('TXT_KEY_GREAT_WORK_AW_120', '미스 잔 고닌'),
	('TXT_KEY_GREAT_WORK_AW_130', '더 옥스보우'),
	('TXT_KEY_GREAT_WORK_AW_140', '드레스덴의 달밤 풍경'),
	('TXT_KEY_GREAT_WORK_AW_150', '사냥'),
	('TXT_KEY_GREAT_WORK_AW_160', '스탄치크'),
	('TXT_KEY_GREAT_WORK_AW_170', '물고기 잡는 원주민'),
	('TXT_KEY_GREAT_WORK_AW_180', '새벽 다리 근처에서의 서프라이즈'),
	('TXT_KEY_GREAT_WORK_AW_190', '짜증 나는 아저씨'),
	('TXT_KEY_GREAT_WORK_AW_200', '겨울 풍경'),
	('TXT_KEY_GREAT_WORK_AW_210', '프시케 거울'),
	('TXT_KEY_GREAT_WORK_AW_220', '11월'),
	('TXT_KEY_GREAT_WORK_AW_230', '하오카흐'),
	('TXT_KEY_GREAT_WORK_AW_240', '독립이냐 죽음이냐'),
	('TXT_KEY_GREAT_WORK_AW_250', '아픈 아이'),
	('TXT_KEY_GREAT_WORK_AW_260', '완두콩 따기'),
	('TXT_KEY_GREAT_WORK_AW_270', '정원에서 갓 따온'),
	('TXT_KEY_GREAT_WORK_AW_280', '양귀비'),
	('TXT_KEY_GREAT_WORK_AW_290', '삼포의 수비'),
	('TXT_KEY_GREAT_WORK_AW_300', '눈내린 뉴욕'),
	('TXT_KEY_GREAT_WORK_AW_310', '로테르담 태양'),
	('TXT_KEY_GREAT_WORK_AW_320', '대장간'),
	('TXT_KEY_GREAT_WORK_AW_330', '수직의 쿠프카의 아내'),
	('TXT_KEY_GREAT_WORK_AW_340', '세기말적인 풍경'),
	('TXT_KEY_GREAT_WORK_AW_350', '동프로이센의 공격에 대한 러시아 기병'),
	('TXT_KEY_GREAT_WORK_AW_360', '로트키나 기병 돌격'),
	('TXT_KEY_GREAT_WORK_AW_370', '밤의 항구 사진'),
	('TXT_KEY_GREAT_WORK_AW_380', '겨울밤'),
	('TXT_KEY_GREAT_WORK_AW_390', '파란 눈을 가진 소년'),
	('TXT_KEY_GREAT_WORK_AW_400', '빨강, 파랑, 노랑과 검정으로'),
	('TXT_KEY_GREAT_WORK_AW_410', '블루 앤 그린 음악'),
	('TXT_KEY_GREAT_WORK_AW_420', '마리아 나브로카의 초상'),
	('TXT_KEY_GREAT_WORK_AW_430', '아바포루'),
	('TXT_KEY_GREAT_WORK_AW_440', '자화상'),
	('TXT_KEY_GREAT_WORK_AW_450', '정물화'),
	('TXT_KEY_GREAT_WORK_AW_460', '통킹의 농민 여성들'),
	('TXT_KEY_GREAT_WORK_AW_470', '가을 산의 고독한 사원'),
	('TXT_KEY_GREAT_WORK_AW_480', '보라색 코트를 입은 여인'),
	('TXT_KEY_GREAT_WORK_AW_490', '벌새와 가시 목걸이를 한 자화상'),
	('TXT_KEY_GREAT_WORK_AW_500', '지하철 환타지'),
	('TXT_KEY_GREAT_WORK_AW_510', '밤을 지새우는 사람들'),
	('TXT_KEY_GREAT_WORK_AW_520', '메이드 토에이의 초상'),
	('TXT_KEY_GREAT_WORK_AW_530', '옛 시절'),
	('TXT_KEY_GREAT_WORK_AW_540', '희망의 빛'),
	('TXT_KEY_GREAT_WORK_AW_550', '욕망이라는 이름의 전차로부터'),
	('TXT_KEY_GREAT_WORK_AW_560', '넘버 17-A'),
	('TXT_KEY_GREAT_WORK_AW_570', '화이트 인테리어'),
	('TXT_KEY_GREAT_WORK_AW_580', '무제'),
	('TXT_KEY_GREAT_WORK_AW_590', '선구'),
	('TXT_KEY_GREAT_WORK_AW_600', '마릴린 먼로 두 폭'),
	('TXT_KEY_GREAT_WORK_AW_610', '백지위임장'),
	('TXT_KEY_GREAT_WORK_AW_620', '큰 첨벙'),
	('TXT_KEY_GREAT_WORK_AW_630', '베가 200'),
	('TXT_KEY_GREAT_WORK_AW_640', '썬더버드'),
	('TXT_KEY_GREAT_WORK_AW_650', '우키'),
	('TXT_KEY_GREAT_WORK_AW_660', '무제'),
	('TXT_KEY_GREAT_WORK_AW_670', '가을 등급'),
	('TXT_KEY_GREAT_WORK_AW_680', '크리스탈 그릇이 있는 정물'),
	('TXT_KEY_GREAT_WORK_AW_690', '파비안'),
	('TXT_KEY_GREAT_WORK_AW_700', '여성성'),
	('TXT_KEY_GREAT_WORK_AW_710', '자기 이미지'),
	('TXT_KEY_GREAT_WORK_AW_720', '무제'),
	('TXT_KEY_GREAT_WORK_AW_730', '더스트헤드'),
	('TXT_KEY_GREAT_WORK_AW_740', '출발 알람 II'),
	('TXT_KEY_GREAT_WORK_AW_750', '이야기꾼의 시대'),
	('TXT_KEY_GREAT_WORK_AW_760', '인물 시리즈 3번'),
	('TXT_KEY_GREAT_WORK_AW_770', '꽃'),
	('TXT_KEY_GREAT_WORK_AW_780', '붉은 잉꼬'),
	('TXT_KEY_GREAT_WORK_AW_790', '기묘한 폭력과 하얀 여신들'),
	('TXT_KEY_GREAT_WORK_AW_800', '봄의 기분 I'),
	('TXT_KEY_GREAT_WORK_AW_810', '무제'),
	('TXT_KEY_GREAT_WORK_AW_820', '새벽의 아실라'),
	('TXT_KEY_GREAT_WORK_AW_830', '딘, 트레스 벨 네그레스 1'),
	('TXT_KEY_GREAT_WORK_AW_840', '딸을 안고 있는 자화상'),
	('TXT_KEY_GREAT_WORK_AW_850', '전쟁이 아닌 예술을 만들어라'),
	('TXT_KEY_GREAT_WORK_AW_860', '해변의 아침'),
	('TXT_KEY_GREAT_WORK_AW_870', '우주의 중심쪽으로'),
	('TXT_KEY_GREAT_WORK_AW_880', '아이 온 더 타임'),
	('TXT_KEY_GREAT_WORK_AW_890', '무제'),
	('TXT_KEY_GREAT_WORK_AW_900', '안크 슈스');
