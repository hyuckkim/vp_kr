...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_AMBRACIA', '[COLOR_POSITIVE_TEXT]Mercenaries of Pyrrhus[ENDCOLOR]: Land Garrisons generate +5% [ICON_PRODUCTION] Production. +50% Militaristic City-State Gift Rate.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_DJIBOUTI', '[COLOR_POSITIVE_TEXT]Ta Netjeru[ENDCOLOR]: -5% [ICON_HAPPINESS_3] Poverty in all cities.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_DODOMA', '[COLOR_POSITIVE_TEXT]Sail in the Wilderness[ENDCOLOR]: Naval Ships gain +5% [ICON_STRENGTH] Combat Strength and +1 [ICON_MOVES] Movement.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_FAYA', '[COLOR_POSITIVE_TEXT]Spoils of War[ENDCOLOR]: Military Kills generate [ICON_RESEARCH] Science equivalent to 50% of the killed''s strength.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_KIGALI', '[COLOR_POSITIVE_TEXT]Double Shift Curriculum[ENDCOLOR]: -5% [ICON_HAPPINESS_3] Illiteracy in all cities.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_NAIROBI', '[COLOR_POSITIVE_TEXT]Harambee[ENDCOLOR]: -5% [ICON_HAPPINESS_3] Distress in all cities.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_QUELIMANE', '[COLOR_POSITIVE_TEXT]River of the Good Signs[ENDCOLOR]: River Tiles yield +1 [ICON_GOLDEN_AGE] Golden Age Points.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_SIERRA_LEONE', '[COLOR_POSITIVE_TEXT]Realm of the Free[ENDCOLOR]: -5% [ICON_HAPPINESS_3] Boredom in all cities.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_SURREY', '[COLOR_POSITIVE_TEXT]Magnificence in Flying Machines[ENDCOLOR]: Fighters and Bombers gain +10% [ICON_STRENGTH] Combat Strength VS [COLOR_POSITIVE_TEXT]Naval[ENDCOLOR] and [COLOR_POSITIVE_TEXT]Land[ENDCOLOR] Units.' UNION ALL
