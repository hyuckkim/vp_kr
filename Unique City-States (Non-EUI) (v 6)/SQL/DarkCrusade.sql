...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT', '[COLOR_POSITIVE_TEXT]Crusader''s Zeal[ENDCOLOR]: Newly-produced Melee and Gun Units receive a random 10 Turn Promotion bonus upon their first combat and Military Units generate +33% Experience gained from combat.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_HONDURAS', '[COLOR_POSITIVE_TEXT]Banana Republic[ENDCOLOR]: Resources from City-States count toward Global Monopolies.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_AUCKLAND', '[COLOR_POSITIVE_TEXT]Tamaki Makaurau[ENDCOLOR]: +3 [ICON_FOOD] Food to Coastal Cities.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_ARMAGH', '[COLOR_POSITIVE_TEXT]Patron of Saints[ENDCOLOR]: May faith-purchase Saints (Requires a Majority Religion).[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_MUSCAT', '[COLOR_POSITIVE_TEXT]Cryptus Portus[ENDCOLOR]: Lighthouses, Harbors, and Seaports produce +1 [ICON_GOLD] Gold.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_GRANADA', '[COLOR_POSITIVE_TEXT]Alcázars[ENDCOLOR]: Forts and Citadels produce +1 [ICON_CULTURE] Culture.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_NANMANDOL', '[COLOR_POSITIVE_TEXT]Reef of Heaven[ENDCOLOR]: +1 [ICON_CULTURE] Culture to Oceans.[NEWLINE]' UNION ALL
...
SELECT 'MINOR_CIV_CLERMONT', 'TXT_KEY_CITYSTATE_CLERMONT', 'TXT_KEY_CIV5_CLERMONT_TEXT', 'TXT_KEY_CITYSTATE_CLERMONT', 'TXT_KEY_CITYSTATE_CLERMONT_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_WHITE', 'ARTSTYLE_EUROPEAN', '_EURO', 'EUROPEAN', 'MINOR_TRAIT_MILITARISTIC' UNION ALL
SELECT 'MINOR_CIV_HONDURAS', 'TXT_KEY_CITYSTATE_HONDURAS', 'TXT_KEY_CIV5_HONDURAS_TEXT', 'TXT_KEY_CITYSTATE_HONDURAS', 'TXT_KEY_CITYSTATE_HONDURAS_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_LIGHT_GREEN', 'ARTSTYLE_SOUTH_AMERICA', '_AMER', 'AMERICAN', 'MINOR_TRAIT_MERCANTILE' UNION ALL
SELECT 'MINOR_CIV_AUCKLAND', 'TXT_KEY_CITYSTATE_AUCKLAND', 'TXT_KEY_CIV5_AUCKLAND_TEXT', 'TXT_KEY_CITYSTATE_AUCKLAND', 'TXT_KEY_CITYSTATE_AUCKLAND_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_BLUE', 'ARTSTYLE_ASIAN', '_ASIA', 'ASIAN', 'MINOR_TRAIT_MARITIME' UNION ALL
SELECT 'MINOR_CIV_ARMAGH', 'TXT_KEY_CITYSTATE_ARMAGH', 'TXT_KEY_CIV5_ARMAGH_TEXT', 'TXT_KEY_CITYSTATE_ARMAGH', 'TXT_KEY_CITYSTATE_ARMAGH_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_CYAN', 'ARTSTYLE_EUROPEAN', '_EURO', 'EUROPEAN', 'MINOR_TRAIT_RELIGIOUS' UNION ALL
SELECT 'MINOR_CIV_MUSCAT', 'TXT_KEY_CITYSTATE_MUSCAT', 'TXT_KEY_CIV5_MUSCAT_TEXT', 'TXT_KEY_CITYSTATE_MUSCAT', 'TXT_KEY_CITYSTATE_MUSCAT_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_GREEN', 'ARTSTYLE_MIDDLE_EAST', '_AFRI', 'AFRICAN', 'MINOR_TRAIT_MERCANTILE' UNION ALL
SELECT 'MINOR_CIV_GRANADA', 'TXT_KEY_CITYSTATE_GRANADA', 'TXT_KEY_CIV5_GRANADA_TEXT', 'TXT_KEY_CITYSTATE_GRANADA', 'TXT_KEY_CITYSTATE_GRANADA_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_YELLOW', 'ARTSTYLE_EUROPEAN', '_EURO', 'EUROPEAN', 'MINOR_TRAIT_MILITARISTIC' UNION ALL
SELECT 'MINOR_CIV_NANMANDOL', 'TXT_KEY_CITYSTATE_NANMANDOL', 'TXT_KEY_CIV5_NANMANDOL_TEXT', 'TXT_KEY_CITYSTATE_NANMANDOL', 'TXT_KEY_CITYSTATE_NANMANDOL_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_PEACH', 'ARTSTYLE_ASIAN', '_ASIA', 'ASIAN', 'MINOR_TRAIT_CULTURED';
...
SELECT 'PROMOTION_CLERMONT', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT0', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT0_HELP', 1, 'AS2D_IF_LEVELUP', 0, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_CLERMONT' UNION ALL
SELECT 'PROMOTION_CLERMONT1', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT1', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT1_HELP', 1, 'AS2D_IF_LEVELUP', 1, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_CLERMONT' UNION ALL
SELECT 'PROMOTION_CLERMONT2', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT2', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT2_HELP', 1, 'AS2D_IF_LEVELUP', 2, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_CLERMONT' UNION ALL
SELECT 'PROMOTION_CLERMONT3', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT3', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT3_HELP', 1, 'AS2D_IF_LEVELUP', 3, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_CLERMONT' UNION ALL
SELECT 'PROMOTION_CLERMONT4', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT4', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT4_HELP', 1, 'AS2D_IF_LEVELUP', 4, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_CLERMONT' UNION ALL
SELECT 'PROMOTION_CLERMONT5', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT5', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT5_HELP', 1, 'AS2D_IF_LEVELUP', 5, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_CLERMONT' UNION ALL
SELECT 'PROMOTION_CLERMONT6', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT6', 'TXT_KEY_CSTRAIT_MINOR_CIV_CLERMONT6_HELP', 1, 'AS2D_IF_LEVELUP', 6, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_CLERMONT';
