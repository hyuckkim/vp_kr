...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_GWYNEDD', '[COLOR_POSITIVE_TEXT]Cyfraith Hywel[ENDCOLOR]: +10% [ICON_CULTURE] Culture during Golden Ages.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_MUISCA', '[COLOR_POSITIVE_TEXT]The Golden One[ENDCOLOR]: +1 [ICON_GOLD] Gold per 2 Citizens in the Capital and +1 [ICON_GOLD] Gold for every 30 citizens in your Empire.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_LACONIA', '[COLOR_POSITIVE_TEXT]Spartan Discipline[ENDCOLOR]: +10% [ICON_STRENGTH] Combat Strength when adjacent to a friendly unit.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_CHEVAK', '[COLOR_POSITIVE_TEXT]Cev''aq[ENDCOLOR]: +1 [ICON_FOOD] Food for every 4 Tundra Tiles or 3 Snow Tiles within workable radius.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_SANTO_DOMINGO', '[COLOR_POSITIVE_TEXT]Caribbean''s Gateway[ENDCOLOR]: +3 to the sum of Yields and Happiness from Global Monopolies.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_MANAGUA', '[COLOR_POSITIVE_TEXT]Place of the Big Man[ENDCOLOR]: +7% to the sum of Yields and Golden Age duration modifiers from Global Monopolies.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_ODENSO', '[COLOR_POSITIVE_TEXT]Lord of the Hunt[ENDCOLOR]: Military Units gain +1 Vision and heal an additional 5 HP per turn in neutral territories.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_YANGCHENG', '[COLOR_POSITIVE_TEXT]Year of the Animal[ENDCOLOR]: +1 [ICON_PEACE] Faith on Animal Resources.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_PHANOTEUS', '[COLOR_POSITIVE_TEXT]Gift of Promethesus[ENDCOLOR]: Chance of rigged elections and coups in City-States increased by +25%.  Spies +25% more likely to capture enemy spies in owned cities. Spies steal Technologies and Great Works +25% faster.[NEWLINE]' UNION ALL
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_DOUALA', '[COLOR_POSITIVE_TEXT]Minature Continent[ENDCOLOR]: +1 [ICON_INTERNATIONAL_TRADE] Trade Route.[NEWLINE]' UNION ALL
...
SELECT 'MINOR_CIV_GWYNEDD', 'TXT_KEY_CITYSTATE_GWYNEDD', 'TXT_KEY_CIV5_GWYNEDD_TEXT', 'TXT_KEY_CITYSTATE_GWYNEDD', 'TXT_KEY_CITYSTATE_GWYNEDD_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_LIGHT_PURPLE', 'ARTSTYLE_EUROPEAN', '_EURO', 'EUROPEAN', 'MINOR_TRAIT_CULTURED' UNION ALL
SELECT 'MINOR_CIV_MUISCA', 'TXT_KEY_CITYSTATE_MUISCA', 'TXT_KEY_CIV5_MUISCA_TEXT', 'TXT_KEY_CITYSTATE_MUISCA', 'TXT_KEY_CITYSTATE_MUISCA_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_WHITE', 'ARTSTYLE_SOUTH_AMERICA', '_AMER', 'AMERICAN', 'MINOR_TRAIT_MERCANTILE' UNION ALL
SELECT 'MINOR_CIV_LACONIA', 'TXT_KEY_CITYSTATE_LACONIA', 'TXT_KEY_CIV5_LACONIA_TEXT', 'TXT_KEY_CITYSTATE_LACONIA', 'TXT_KEY_CITYSTATE_LACONIA_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_LIGHT_GREEN', 'ARTSTYLE_GRECO_ROMAN', '_MED', 'MEDITERRANEAN', 'MINOR_TRAIT_MILITARISTIC' UNION ALL
SELECT 'MINOR_CIV_CHEVAK', 'TXT_KEY_CITYSTATE_CHEVAK', 'TXT_KEY_CIV5_CHEVAK_TEXT', 'TXT_KEY_CITYSTATE_CHEVAK', 'TXT_KEY_CITYSTATE_CHEVAK_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_CYAN', 'ARTSTYLE_SOUTH_AMERICA', '_AMER', 'AMERICAN', 'MINOR_TRAIT_MARITIME' UNION ALL
SELECT 'MINOR_CIV_SANTO_DOMINGO', 'TXT_KEY_CITYSTATE_SANTO_DOMINGO', 'TXT_KEY_CIV5_SANTO_DOMINGO_TEXT', 'TXT_KEY_CITYSTATE_SANTO_DOMINGO', 'TXT_KEY_CITYSTATE_SANTO_DOMINGO_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_LIGHT_YELLOW', 'ARTSTYLE_EUROPEAN', '_EURO', 'EUROPEAN', 'MINOR_TRAIT_MERCANTILE' UNION ALL
SELECT 'MINOR_CIV_MANAGUA', 'TXT_KEY_CITYSTATE_MANAGUA', 'TXT_KEY_CIV5_MANAGUA_TEXT', 'TXT_KEY_CITYSTATE_MANAGUA', 'TXT_KEY_CITYSTATE_MANAGUA_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_PEACH', 'ARTSTYLE_EUROPEAN', '_EURO', 'EUROPEAN', 'MINOR_TRAIT_MERCANTILE' UNION ALL
SELECT 'MINOR_CIV_ODENSO', 'TXT_KEY_CITYSTATE_ODENSO', 'TXT_KEY_CIV5_ODENSO_TEXT', 'TXT_KEY_CITYSTATE_ODENSO', 'TXT_KEY_CITYSTATE_ODENSO_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_MIDDLE_PURPLE', 'ARTSTYLE_EUROPEAN', '_EURO', 'EUROPEAN', 'MINOR_TRAIT_MILITARISTIC' UNION ALL
SELECT 'MINOR_CIV_YANGCHENG', 'TXT_KEY_CITYSTATE_YANGCHENG', 'TXT_KEY_CIV5_YANGCHENG_TEXT', 'TXT_KEY_CITYSTATE_YANGCHENG', 'TXT_KEY_CITYSTATE_YANGCHENG_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_GRAY', 'ARTSTYLE_ASIAN', '_ASIA', 'ASIAN', 'MINOR_TRAIT_RELIGIOUS' UNION ALL
SELECT 'MINOR_CIV_PHANOTEUS', 'TXT_KEY_CITYSTATE_PHANOTEUS', 'TXT_KEY_CIV5_PHANOTEUS_TEXT', 'TXT_KEY_CITYSTATE_PHANOTEUS', 'TXT_KEY_CITYSTATE_PHANOTEUS_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_LIGHT_BLUE', 'ARTSTYLE_GRECO_ROMAN', '_MED', 'MEDITERRANEAN', 'MINOR_TRAIT_MILITARISTIC' UNION ALL
SELECT 'MINOR_CIV_DOUALA', 'TXT_KEY_CITYSTATE_DOUALA', 'TXT_KEY_CIV5_DOUALA_TEXT', 'TXT_KEY_CITYSTATE_DOUALA', 'TXT_KEY_CITYSTATE_DOUALA_ADJ', 'ART_DEF_CIVILIZATION_MINOR', 'PLAYERCOLOR_MINOR_MIDDLE_BLUE', 'ARTSTYLE_MIDDLE_EAST', '_AFRI', 'AFRICAN', 'MINOR_TRAIT_MERCANTILE';
...
SELECT 'PROMOTION_LACONIA', 'TXT_KEY_CITYSTATE_LACONIA', 'TXT_KEY_CSTRAIT_MINOR_CIV_LACONIA', 1, 'AS2D_IF_LEVELUP', 10, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_LACONIA' UNION ALL
SELECT 'PROMOTION_ODENSO', 'TXT_KEY_CITYSTATE_ODENSO', 'TXT_KEY_CSTRAIT_MINOR_CIV_ODENSO', 1, 'AS2D_IF_LEVELUP', 12, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_ODENSO';
