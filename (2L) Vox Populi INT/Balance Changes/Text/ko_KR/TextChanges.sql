...
UPDATE Language_ko_KR
SET Text = '도시 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR]를 [ICON_GOLD]골드로 전환하고 도시의 [ICON_GOLD]빈곤을 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 감소시킵니다.'
WHERE Tag = 'TXT_KEY_PROCESS_WEALTH_HELP';

UPDATE Language_ko_KR
SET Text = '도시 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR]를 [ICON_RESEARCH]과학으로 전환하고 도시의 [ICON_RESEARCH]문맹을 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 감소시킵니다.'
