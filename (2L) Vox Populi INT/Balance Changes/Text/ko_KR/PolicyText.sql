...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]조직화[ENDCOLOR][NEWLINE][NEWLINE][ICON_BULLET]모든 도시의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]노동자의 [ICON_MOVES]이동력이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]노동자 및 교역 유닛을 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 더 빠르게 생산할 수 있습니다.'
