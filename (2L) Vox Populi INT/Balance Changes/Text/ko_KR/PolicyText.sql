...
UPDATE Language_ko_KR
SET Text = '회적 평등은 특정 사회나 고립된 집단의 모든 사람들이 종종 시민권, 언론의 자유, 재산권, 그리고 사회적 재화와 서비스에 대한 동등한 접근을 포함한 특정한 측면에서 동일한 지위를 갖는 상황입니다. 그러나 건강 평등, 경제적 평등 및 기타 사회 보장 개념도 포함됩니다. 그것은 또한 동등한 기회와 의무를 포함하며, 따라서 사회 전체를 포함합니다. 사회적 평등은 법적으로 강제된 사회적 계급이나 카스트 경계의 부재와 개인의 정체성의 양도 불가능한 부분에 의해 동기 부여되는 차별의 부재가 필요합니다.'
