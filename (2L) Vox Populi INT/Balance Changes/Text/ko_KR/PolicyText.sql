...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]의식[ENDCOLOR][NEWLINE][ICON_BULLET]모든 국가 불가사의의 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET][ICON_CAPITAL]수도에 [COLOR_YELLOW]궁정 점술사[ENDCOLOR]가 출현합니다.([ICON_RESEARCH]과학 +3, 모든 도시에서 자문회, 훈제실, 약초상에 [ICON_RESEARCH]과학 +1, [ICON_VP_SCIENTIST] 과학자 슬롯 +1)'
