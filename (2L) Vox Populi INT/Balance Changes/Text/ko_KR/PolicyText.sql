...
-- Futurism
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]미래파[ENDCOLOR]: 궁전의 [COLOR_POSITIVE_TEXT]역사적 사건[ENDCOLOR]을 강화합니다. 모든 [ICON_GREAT_WORK]걸작에서 오는 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 도시를 정복했을 때 [ICON_TOURISM]관광을 [COLOR_POSITIVE_TEXT]50[ENDCOLOR] 제공합니다. 이 효과는 도시별로 한 번만 적용됩니다.'
