...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문화유산[ENDCOLOR][NEWLINE][ICON_GREAT_WORK] 걸작 음악의 [ICON_GOLD] 골드가 +4 증가합니다. 모든 대학의 [ICON_GOLDEN_AGE]황금기 점수 및 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다. 세계 불가사의, 타일의 [ICON_CULTURE] 문화의 25%가 도시의 [ICON_TOURISM] 관광에 추가됩니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]국보[ENDCOLOR][NEWLINE]유물의 [ICON_RESEARCH] 과학이 +2 증가합니다. [ICON_CAPITAL]수도 근처에 원하는 [ICON_GREAT_PEOPLE][COLOR_YELLOW]위인[ENDCOLOR]이 1명 출현합니다. [ICON_GREAT_PEOPLE]세계 불가사의를 건설할 때 [ICON_GOLD]골드를 [COLOR_POSITIVE_TEXT]250[ENDCOLOR] [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR] 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]자유무역[ENDCOLOR][NEWLINE][ICON_GREAT_MERCHANT]위대한 상인 출현율이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다. [ICON_INTERNATIONAL_TRADE]교역로에서 오는 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]5[ENDCOLOR] 증가합니다. 모든 도시의 [ICON_GOLD]빈곤 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]-2[ENDCOLOR] 감소합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]계엄령[ENDCOLOR][NEWLINE][ICON_PUPPET]괴뢰 도시의 산출량 페널티가 [COLOR_NEGATIVE_TEXT]80%[ENDCOLOR]에서 [COLOR_POSITIVE_TEXT]60%[ENDCOLOR]로 감소합니다. 유닛이 도시에 주둔하면 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하고 도시의 문화가 4 증가합니다. 더이상 도시에 주둔한 유닛의 [ICON_GOLD]유지비가 들지 않습니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]착취[ENDCOLOR][NEWLINE]농장, 야영지, 재배지의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 대양, 해안, 호수 타일의 [ICON_RESEARCH]과학 및 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문명화 사명[ENDCOLOR][NEWLINE]도시를 점령할 때 대량의 [ICON_GOLD]골드를 제공합니다. (시대와 도시의 인구수에 따라 보정) [ICON_PUPPET]괴뢰 도시 및 법원이 있는 도시에서 건물을 생산할 때 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 제공하고 현재 시대와 건물 시대의 [COLOR_POSITIVE_TEXT]차이[ENDCOLOR]만큼 추가적으로 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]지배[ENDCOLOR][NEWLINE]적 군사 유닛을 처치할 때 처치한 유닛의 [ICON_STRENGTH]전투력의 100% 만큼 [ICON_RESEARCH]과학을 제공합니다. 근접 유닛이 적 군사 유닛을 처치할 때 체력을 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] 회복합니다. 유닛 보급 한도가 [ICON_CITIZEN]시민의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]만큼 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]조직화[ENDCOLOR][NEWLINE]모든 시민 유닛의 [ICON_MOVES]이동력이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 개척자, 노동자 및 교역 유닛을 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 더 빠르게 생산할 수 있습니다. 모든 도시의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]평등[ENDCOLOR][NEWLINE]모든 도시의 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [ICON_CITIZEN]시민 15명마다 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 도시의 [ICON_GOLD]빈곤, [ICON_RESEARCH]문맹, [ICON_CULTURE]무료, [ICON_FOOD]/[ICON_PRODUCTION]곤경 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]-1[ENDCOLOR] 감소합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외교국[ENDCOLOR][NEWLINE]추가 [ICON_SPY][COLOR_YELLOW]스파이[ENDCOLOR]를 1명 ([ICON_CITY_STATE]도시 국가가 20개 이상이라면 10개마다 하나씩 추가로 더) 제공합니다. 도시 국가의 퀘스트 보상이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다. 교역로에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]신성한 권리[ENDCOLOR][NEWLINE]매 턴 도시 [ICON_HAPPINESS_1]행복의 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR]가 [ICON_CULTURE]문화로 전환됩니다. 모든 도시의 [ICON_CULTURE]무료 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]-2[ENDCOLOR] 감소합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]과학혁명[ENDCOLOR][NEWLINE]모든 도시에 천문대를 건설할 수 있습니다. 모든 정글과 설원 타일의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가하고 현재 소유한 [ICON_GREAT_WORK]걸작 1개마다 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] [COLOR:105:105:105:255](한도: 20%)[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]경험주의[ENDCOLOR][NEWLINE]모든 도시에서 스파이 저항이 [COLOR_POSITIVE_TEXT]34%[ENDCOLOR] 증가합니다. 전문가가 소모하는 [ICON_FOOD]식량이 평소보다 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] [COLOR:105:105:105:255](한도: [ICON_FOOD]1)[ENDCOLOR] 감소합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]정의[ENDCOLOR][NEWLINE]모든 도시의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하고 유닛이 주둔한 도시의 [ICON_RANGE_STRENGTH]원거리 전투력이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [ICON_CAPITAL]수도에 [COLOR_YELLOW]근위병 초소[ENDCOLOR]가 출현합니다. (기술자 전문가 슬롯 +1, [ICON_STRENGTH]방어력 +3, 체력 +50, 군사 유닛 보급 한도가 시민의 20%만큼 증가, [ICON_PRODUCTION]생산 +3)'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]주권[ENDCOLOR][NEWLINE]새로운 타일을 확보하기 위해 필요한 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 감소합니다. [ICON_CAPITAL]수도에 [COLOR_YELLOW]궁정 예배당[ENDCOLOR]이 출현합니다.(예술가 전문가 슬롯 +1, [ICON_GREAT_WORK]걸작 예술품 슬롯 +1 , [ICON_PEACE]신앙 +3)'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]존엄[ENDCOLOR][NEWLINE][ICON_CAPITAL]수도의 전문가가 소모하는 [ICON_FOOD]식량이 평소보다 [COLOR_POSITIVE_TEXT]절반[ENDCOLOR] [COLOR:105:105:105:255](한도: [ICON_FOOD]1)[ENDCOLOR] 감소합니다. [ICON_CAPITAL]수도에 [COLOR_YELLOW]국고[ENDCOLOR]가 출현합니다.(상인 전문가 슬롯 +1, [ICON_GOLD]골드 +4, [ICON_GREAT_PEOPLE]위인 출현율 +25%)'
