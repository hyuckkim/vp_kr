...
-- Futurism
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]미래파[ENDCOLOR]: 게임 시작시 부터 가능한 "역사적 사건"에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]40%[ENDCOLOR] 증가하고 모든 [ICON_GREAT_WORK]걸작에서 오는 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 도시를 정복했을 때 [ICON_TOURISM]관광을 [COLOR_POSITIVE_TEXT]50[ENDCOLOR] 제공합니다. 이 효과는 도시별로 한 번만 적용됩니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문화유산[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_GREAT_WORK] 걸작 음악의 [ICON_GOLD] 골드가 +4 증가합니다. [NEWLINE][ICON_BULLET]모든 대학의 [ICON_GOLDEN_AGE]황금기 점수 및 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET][ICON_WONDER] 세계 불가사의, 타일의 [ICON_CULTURE] 문화의 25%가 도시의 [ICON_TOURISM] 관광에 추가됩니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]국보[ENDCOLOR][NEWLINE][ICON_BULLET] [ICON_GREAT_WORK] 유물의 [ICON_RESEARCH] 과학이 +2 증가합니다. [NEWLINE][ICON_BULLET][ICON_CAPITAL]수도 근처에 원하는 [ICON_GREAT_PEOPLE][COLOR_YELLOW]위인[ENDCOLOR]이 1명 출현합니다. [NEWLINE][ICON_BULLET][ICON_WONDER] 세계 불가사의를 건설할 때 [ICON_GOLD]골드를 [COLOR_POSITIVE_TEXT]250[ENDCOLOR] [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR] 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]과학혁명[ENDCOLOR][NEWLINE][ICON_BULLET]모든 도시에 천문대를 건설할 수 있습니다. ([ICON_RESEARCH] 과학 +6, 근처 산마다 [ICON_RESEARCH] 과학 1, 과학자 전문가 슬롯 2)[NEWLINE][ICON_BULLET]현재 소유한 [ICON_GREAT_WORK]걸작 1개마다 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] 증가합니다.[COLOR:105:105:105:255](한도: 20%)[ENDCOLOR][NEWLINE][ICON_BULLET]모든 정글과 설원 타일의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.'
