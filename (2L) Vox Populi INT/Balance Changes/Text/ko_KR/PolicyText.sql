...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]계엄령[ENDCOLOR][NEWLINE][ICON_BULLET]유닛이 도시에 주둔하면 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하고 도시의 문화가 4 증가합니다. [NEWLINE][ICON_BULLET]더이상 도시에 주둔한 유닛의 [ICON_GOLD]유지비가 들지 않습니다. [NEWLINE][ICON_BULLET][ICON_PUPPET]괴뢰 도시의 산출량 페널티가 [COLOR_NEGATIVE_TEXT]80%[ENDCOLOR]에서 [COLOR_POSITIVE_TEXT]60%[ENDCOLOR]로 감소합니다.'
