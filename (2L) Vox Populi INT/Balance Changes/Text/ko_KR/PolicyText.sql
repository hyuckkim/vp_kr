...
-- Capitalism
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]자본주의[ENDCOLOR]: 도시마다 전문가 [COLOR_POSITIVE_TEXT]2명[ENDCOLOR]이 도시화에서 오는 [ICON_HAPPINESS_3]불행을 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소시키는 대신에 [ICON_HAPPINESS_1]행복을 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가시킵니다. 모든 전문가의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] [ICON_GOLD]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]계엄령[ENDCOLOR][NEWLINE][ICON_BULLET]더이상 도시에 주둔한 유닛의 [ICON_GOLD]유지비가 들지 않습니다. [NEWLINE][ICON_BULLET]유닛이 도시에 주둔하면 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하고 도시의 문화가 4 증가합니다. [NEWLINE][ICON_BULLET][ICON_PUPPET]괴뢰 도시의 산출량 페널티가 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 감소합니다.'
