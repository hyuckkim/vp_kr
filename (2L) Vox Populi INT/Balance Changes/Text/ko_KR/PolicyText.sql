...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]신세계 질서[ENDCOLOR]: 모든 도시의 [ICON_FOOD]/[ICON_PRODUCTION]곤경 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다. 모든 경찰서 및 경찰대의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]5[ENDCOLOR] 증가하고 건설 속도가 [COLOR_POSITIVE_TEXT]100%[ENDCOLOR] 빨라집니다.'
...
-- New Deal
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]뉴딜 정책[ENDCOLOR]: 랜드마크 및 위인 시설의 산출량이 [COLOR_POSITIVE_TEXT]6[ENDCOLOR] 증가하고, [ICON_TOURISM]관광이 2 증가합니다.'
...
-- Double Agents
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]이중 간첩[ENDCOLOR]: 추가 [ICON_SPY][COLOR_YELLOW]스파이[ENDCOLOR]를 3명 ([ICON_CITY_STATE]도시 국가가 20개 이상이라면 10개마다 하나씩 추가로)[ENDCOLOR] 제공합니다. 당신 문명의 [ICON_SPY]스파이가 적[ICON_SPY]스파이를 포획할 확률이 [COLOR_POSITIVE_TEXT]두 배[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]공산주의[ENDCOLOR]: [ICON_GOLD]골드로 건물을 가속할 때 비용이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 감소합니다. 불가사의를 건설할 때 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]인본주의[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_GREAT_WORK] 걸작 문학의[ICON_GOLDEN_AGE] 황금기 점수가 +3 증가합니다. [NEWLINE][ICON_BULLET][ICON_GOLDEN_AGE] 황금기를 시작하기 위해 필요한 [ICON_GOLDEN_AGE] 황금기 점수가 25% 감소합니다. [NEWLINE][ICON_BULLET]모든 길드의 [ICON_HAPPINESS_1] 행복이 +1 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]세련[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_GREAT_WORK] 걸작 예술품의 [ICON_CULTURE] 문화가 +2 증가합니다. [NEWLINE][ICON_BULLET]전문가 [COLOR_POSITIVE_TEXT]1명[ENDCOLOR]이 더이상 도시화에서 오는 [ICON_HAPPINESS_3]불행을 증가시키지 않습니다. [NEWLINE][ICON_BULLET]전문가에서 [ICON_CULTURE] 문화를 +1 얻습니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문화유산[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_GREAT_WORK] 걸작 음악의 [ICON_GOLD] 골드가 +4 증가합니다. [NEWLINE][ICON_BULLET]모든 대학의 [ICON_GOLDEN_AGE]황금기 점수 및 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]세계 불가사의, 타일의 [ICON_CULTURE] 문화의 25%가 도시의 [ICON_TOURISM] 관광에 추가됩니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]국보[ENDCOLOR][NEWLINE][ICON_BULLET] [ICON_GREAT_WORK] 유물의 [ICON_RESEARCH] 과학이 +2 증가합니다. [NEWLINE][ICON_BULLET][ICON_CAPITAL]수도 근처에 원하는 [ICON_GREAT_PEOPLE][COLOR_YELLOW]위인[ENDCOLOR]이 1명 출현합니다. [NEWLINE][ICON_BULLET][ICON_GREAT_PEOPLE]세계 불가사의를 건설할 때 [ICON_GOLD]골드를 [COLOR_POSITIVE_TEXT]250[ENDCOLOR] [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR] 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]노동 분업[ENDCOLOR][NEWLINE][NEWLINE][ICON_BULLET]모든 대장간, 풍차, 작업장, 공장, 철도역, 항구의 [ICON_PRODUCTION]생산 및 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] 증가합니다. [ICON_BULLET]철도역 및 항구 건설 시 +100%의 [ICON_PRODUCTION]생산 보너스를 얻습니다.'
...
--Protectionism
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]보호무역주의[ENDCOLOR][NEWLINE] 건물에 투자하는 [ICON_GOLD]골드가 [ICON_PRODUCTION]생산 비용을 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 더 감소시킵니다. [NEWLINE][ICON_BULLET]국제 교역로의 산출량이 [COLOR_POSITIVE_TEXT]33%[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]"국왕 경축일"이 열리는 동안 [ICON_FOOD]식량 및 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]계엄령[ENDCOLOR][NEWLINE][ICON_BULLET]더이상 도시에 주둔한 유닛의 [ICON_GOLD]유지비가 들지 않습니다. [NEWLINE][ICON_BULLET]유닛이 도시에 주둔하면 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하고 도시의 문화가 4 증가합니다. [NEWLINE][ICON_BULLET][ICON_PUPPET]괴뢰 도시의 산출량 페널티가 [COLOR_NEGATIVE_TEXT]80%[ENDCOLOR]에서 [COLOR_POSITIVE_TEXT]60%[ENDCOLOR]로 감소합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]공물[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_CAPITAL]수도 근처에 무료 [COLOR_YELLOW]개척자[ENDCOLOR]가 1명 출현합니다. [NEWLINE][ICON_BULLET][ICON_CITY_STATE] 도시 국가에 무거운 공물을 요구하면 골드가 아닌 산출량이 25% 증가합니다. (모든 {TXT_KEY_POLICY_BRANCH_HONOR} 정책을 채택하면 50%로 증가합니다)'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]지배[ENDCOLOR][NEWLINE][ICON_BULLET]적 군사 유닛을 처치할 때 처치한 유닛의 [ICON_STRENGTH]전투력의 100% 만큼 [ICON_RESEARCH]과학을 제공합니다. [NEWLINE][ICON_BULLET]근접 유닛이 적 군사 유닛을 처치할 때 체력을 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] 회복합니다. [NEWLINE][ICON_BULLET]유닛 보급 한도가 [ICON_CITIZEN]시민의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]만큼 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]조직화[ENDCOLOR][NEWLINE][NEWLINE][ICON_BULLET]모든 도시의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. [ICON_BULLET]모든 시민 유닛의 [ICON_MOVES]이동력이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]개척자, 노동자 및 교역 유닛을 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 더 빠르게 생산할 수 있습니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]자유[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_CAPITAL]수도 근처에 [COLOR_YELLOW]노동자[ENDCOLOR]가 1명 출현합니다. [NEWLINE][ICON_BULLET]모든 도시의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]타일 시설의 건설 속도가 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 빨라집니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]평등[ENDCOLOR][NEWLINE][ICON_BULLET]모든 도시의 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하고 [ICON_CITIZEN]시민 15명마다 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]모든 도시의 [ICON_GOLD]빈곤, [ICON_RESEARCH]문맹, [ICON_CULTURE]무료, [ICON_FOOD]/[ICON_PRODUCTION]곤경 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]-1[ENDCOLOR] 감소합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외교국[ENDCOLOR][NEWLINE][ICON_BULLET]추가 [ICON_SPY][COLOR_YELLOW]스파이[ENDCOLOR]를 1명 ([ICON_CITY_STATE]도시 국가가 20개 이상이라면 10개마다 하나씩 추가로 더) 제공합니다. 도시 국가의 퀘스트 보상이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]교역로에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다.'
...
-- Consulates
UPDATE Language_ko_KR
SET Text ='[COLOR_POSITIVE_TEXT]영사관[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_CITY_STATE]도시 국가 8개마다 세계 대회 추가 [COLOR_YELLOW]대표단[ENDCOLOR]을 1명 확보합니다. [NEWLINE][ICON_BULLET]도시 국가로 향하는 [ICON_INTERNATIONAL_TRADE]교역로가 완료되면 알려진 모든 문명에 [COLOR_POSITIVE_TEXT]역사적 사건[ENDCOLOR]을 발동시킵니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외환 시장[ENDCOLOR][NEWLINE][ICON_BULLET]추가 [ICON_INTERNATIONAL_TRADE][COLOR_YELLOW]교역로[ENDCOLOR]를 1개 제공합니다. [NEWLINE][ICON_BULLET]교역로 1개마다 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET][ICON_CITY_STATE]도시 국가가 제공하는 자원이 독점에 계산 됩니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]농노제[ENDCOLOR][NEWLINE][ICON_BULLET]모든 도시의 비전문가 [ICON_CITIZEN]시민 4명마다 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]목장의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET] 국제 [ICON_INTERNATIONAL_TRADE]교역로의 산출량이 [COLOR_POSITIVE_TEXT]33%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]경험주의[ENDCOLOR][NEWLINE][ICON_BULLET]전문가가 소모하는 [ICON_FOOD]식량이 평소보다 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] [COLOR:105:105:105:255](한도: [ICON_FOOD]1)[ENDCOLOR] 감소합니다. [NEWLINE][ICON_BULLET]모든 도시에서 스파이 저항이 [COLOR_POSITIVE_TEXT]34%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]주권[ENDCOLOR][NEWLINE][ICON_BULLET]새로운 타일을 확보하기 위해 필요한 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 감소합니다. [NEWLINE][ICON_BULLET][ICON_CAPITAL]수도에 [COLOR_YELLOW]궁정 예배당[ENDCOLOR]이 출현합니다.([ICON_PEACE]신앙 +3, [ICON_GREAT_WORK]걸작 예술품 슬롯 +1, 예술가 전문가 슬롯 +1)'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]존엄[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_CAPITAL]수도의 전문가가 소모하는 [ICON_FOOD]식량이 평소보다 [COLOR_POSITIVE_TEXT]절반[ENDCOLOR] [COLOR:105:105:105:255](한도: [ICON_FOOD]1)[ENDCOLOR] 감소합니다. [NEWLINE][ICON_BULLET][ICON_CAPITAL]수도에 [COLOR_YELLOW]국고[ENDCOLOR]가 출현합니다.([ICON_GOLD]골드 +4, [ICON_GREAT_PEOPLE]위인 출현율 +25%, 상인 전문가 슬롯 +1)'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]의식[ENDCOLOR][NEWLINE][ICON_BULLET]모든 국가 불가사의의 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET][ICON_CAPITAL]수도에 [COLOR_YELLOW]궁정 점술사[ENDCOLOR]가 출현합니다.([ICON_RESEARCH]과학 +3, 모든 도시에서 자문회, 오두막, 약초상에 [ICON_RESEARCH]과학 +1, 과학자 전문가 슬롯 +1)'
