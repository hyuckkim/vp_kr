...
UPDATE Language_ko_KR
SET Text = '국경 확장 속도가 [COLOR_POSITIVE_TEXT]34%[ENDCOLOR] 증가합니다. 국경이 확장될 때 [ICON_PEACE]신앙을 [COLOR_POSITIVE_TEXT]20[ENDCOLOR] [COLOR:110:110:110:255](게임 속도별 보정)[ENDCOLOR] [ICON_PRODUCTION]생산을 [COLOR_POSITIVE_TEXT]10[ENDCOLOR] [COLOR:110:110:110:255](게임 속도별 보정)[ENDCOLOR] 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '농장이 건설된 자원 타일의 [ICON_FOOD] 식량이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. 곡창의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '궁전의 [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가하고, 성벽의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 우호 영토 내에서 매 턴 체력을 [COLOR_POSITIVE_TEXT]10[ENDCOLOR] 회복합니다.'
...
INSERT INTO Language_ko_KR (Tag, Text)
SELECT 'TXT_KEY_BUILDING_CHURCH_TOOLTIP', '+4 [ICON_PEACE]신앙, +2 [ICON_CULTURE]문화[NEWLINE][NEWLINE]{TXT_KEY_BUILDING_CHURCH_HELP}';
...
UPDATE Language_ko_KR
SET Text = '도시의 턴 당 [ICON_GOLD] 골드 10마다 [ICON_PEACE] 신앙을 1 생산합니다. [COLOR:110:110:110:255](한도: 도시 내 신도 수의 절반)[ENDCOLOR] 신앙 구매의 10%가 [ICON_GOLD] 골드와 [ICON_PRODUCTION] 생산으로 변환됩니다.'
...
INSERT INTO Language_ko_KR (Tag, Text) 
SELECT 'TXT_KEY_BUILDING_MANDIR_TOOLTIP', '+3 [ICON_PEACE] 신앙[NEWLINE]+2 [ICON_FOOD] 식량[NEWLINE][NEWLINE]{TXT_KEY_BUILDING_MANDIR_HELP}';
...
INSERT INTO Language_ko_KR (Tag, Text)
SELECT 'TXT_KEY_BUILDING_MOSQUE_TOOLTIP', '+3 [ICON_PEACE]신앙[NEWLINE]+2 [ICON_RESEARCH]과학[NEWLINE][NEWLINE]{TXT_KEY_BUILDING_MOSQUE_HELP}';
...
INSERT INTO Language_ko_KR (Tag, Text)
SELECT 'TXT_KEY_BUILDING_ORDER_TOOLTIP', '+2 [ICON_PEACE]신앙[NEWLINE]+3 [ICON_GOLD] 골드[NEWLINE][NEWLINE]{TXT_KEY_BUILDING_ORDER_HELP}';
...
INSERT INTO Language_ko_KR (Tag, Text)
SELECT 'TXT_KEY_BUILDING_PAGODA_TOOLTIP', '+2 [ICON_PEACE] 신앙[NEWLINE][NEWLINE]{TXT_KEY_BUILDING_PAGODA_HELP}';
...
INSERT INTO Language_ko_KR (Tag, Text)
SELECT 'TXT_KEY_BUILDING_STUPA_TOOLTIP', '+3 [ICON_PEACE]신앙[NEWLINE]+3 [ICON_GOLDEN_AGE] 황금기 점수[NEWLINE]+5 [ICON_TOURISM] 관광[NEWLINE]+1 [ICON_HAPPINESS_1] 행복[NEWLINE][NEWLINE]{TXT_KEY_BUILDING_STUPA_HELP}';
...
INSERT INTO Language_ko_KR (Tag, Text)
SELECT 'TXT_KEY_BUILDING_SYNAGOGUE_TOOLTIP', '+2 [ICON_PEACE]신앙[NEWLINE]+3 [ICON_PRODUCTION]생산[NEWLINE][NEWLINE]{TXT_KEY_BUILDING_SYNAGOGUE_HELP}';
...
UPDATE Language_ko_KR
SET Text = '턴 당 [ICON_RESEARCH] 과학 5마다 [ICON_PEACE] 신앙을 +1 얻습니다. [COLOR:110:110:110:255](한도: 도시 내 신도 수의 절반)[ENDCOLOR] [ICON_PEACE] 신앙 구매의 10%를 [ICON_CULTURE] 문화와 [ICON_FOOD] 식량으로 전환합니다.'
WHERE Tag = 'TXT_KEY_BELIEF_LITURGICAL_DRAMA';


INSERT INTO Language_ko_KR (Tag, Text)
VALUES
	('TXT_KEY_BELIEF_GURDWARA_SHORT',		'구루쿨람'),
	('TXT_KEY_BUILDING_GURDWARA_TOOLTIP',	'+2 [ICON_PEACE] 신앙[NEWLINE]+3 [ICON_FOOD] 식량[NEWLINE][NEWLINE]{TXT_KEY_BUILDING_GURDWARA_HELP}'),
	('TXT_KEY_BELIEF_GURDWARA',				'[ICON_PEACE] 신앙으로 구루쿨람을 구매할 수 있습니다'),
	('TXT_KEY_BELIEF_TEOCALLI_SHORT',		'테오칼리'),
	('TXT_KEY_BUILDING_TEOCALLI_TOOLTIP',	'+2 [ICON_PEACE] 신앙[NEWLINE][NEWLINE]{TXT_KEY_BUILDING_TEOCALLI_HELP}'),
	('TXT_KEY_BELIEF_TEOCALLI',				'[ICON_PEACE] 신앙으로 테오칼리를 구매할 수 있습니다'),
	('TXT_KEY_BELIEF_COMMUNALISM_SHORT',	'협력'),
	('TXT_KEY_BELIEF_COMMUNALISM',			'국내 교역로의 [ICON_FOOD] 식량 또는 [ICON_PRODUCTION] 생산 산출이 +3 증가합니다.[COLOR:110:110:110:255](시대별 보정)[ENDCOLOR] 도시에 전문가가 있다면 [ICON_PRODUCTION] 생산을 +2 얻습니다.');
