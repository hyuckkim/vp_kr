...
UPDATE Language_ko_KR
SET Text = '농장이 건설된 [ICON_RES_WHEAT]밀,  [ICON_RES_MAIZE]옥수수, [ICON_RES_RICE]쌀의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. 곡창의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'
