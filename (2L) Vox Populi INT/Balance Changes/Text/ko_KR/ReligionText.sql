...
UPDATE Language_ko_KR
SET Text = '농장이 건설된 자원 타일의 식량이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. 곡창의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'
