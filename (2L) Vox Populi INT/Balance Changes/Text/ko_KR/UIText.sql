...
[COLOR_NEGATIVE_TEXT]곤경[ENDCOLOR]: 곤경은 [ICON_FOOD] 식량과 [ICON_PRODUCTION] 생산 산출의 평균에 기반합니다. 식량을 대부분 소비하는 대도시는 곤경을 없애기 어려울 수 있습니다. 국내 교역로가 식량 또는 생산을 증가시켜 빈곤을 없애는 대 도움을 줄 수 있습니다. 농업의 생산 또한 곤경을 막을 수 있습니다.[NEWLINE]
