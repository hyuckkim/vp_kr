...
UPDATE Language_ko_KR
SET Text = '{TXT_KEY_UNIT_CHINESE_CHUKONU}은 중국의 고유 유닛으로 {TXT_KEY_UNIT_CROSSBOWMAN}을 대체합니다.'
...
UPDATE Language_ko_KR
SET Text = '[ICON_WONDER] 불가사의 [ICON_PRODUCTION] 생산력이 +20%, [ICON_GOLDEN_AGE] 황금기에는 2배 증가 합니다. 도시를 건설하거나 (누구든지 [COLOR_CYAN]고고학[ENDCOLOR]에 도달하기 전에) [ICON_WONDER] 세계 불가사의를 완성할 때 근처의 [ICON_RES_ARTIFACTS] 고대 유적지를 드러냅니다. [ICON_RES_ARTIFACTS] 고대 유적지는 [ICON_GOLDEN_AGE] 황금기가 시작될 때마다 [ICON_RESEARCH] 과학, [ICON_CULTURE] 문화, [ICON_PEACE] 신앙이 +1 증가합니다. (최대 +5)'
...
UPDATE Language_ko_KR
SET Text = '[ICON_CITY_STATE] 도시 국가에 선물한 각 유닛들은 턴마다 [ICON_INFLUENCE] 영향력을 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 상승시킵니다. (처치되거나 업그레이드 되면 사라집니다) 군사 유닛, 노동자, 작업선의 [ICON_PRODUCTION] 생산 비용과 [ICON_GOLD] 골드 비용이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 감소합니다.'
...
--------------------
UPDATE Language_ko_KR
SET Text = '도시 국가에 대한 [ICON_INFLUENCE]영향력이 줄어드는 속도가 [COLOR_POSITIVE_TEXT]2/3[ENDCOLOR]으로 감소하고 회복하는 속도는 [COLOR_POSITIVE_TEXT]두 배[ENDCOLOR] 증가합니다. [COLOR_POSITIVE_TEXT]동맹[ENDCOLOR]인 [ICON_CITY_STATE]도시 국가 1개마다 아군 유닛 및 동맹 도시 국가 유닛의 [ICON_STRENGTH]전투력 보너스가 [COLOR_POSITIVE_TEXT]5%[ENDCOLOR] [COLOR:105:105:105:255](한도: 25%)[ENDCOLOR] 증가합니다. 아군 유닛이 도시 국가 영토를 우호적인 영토로 사용합니다.'
WHERE Tag = 'TXT_KEY_TRAIT_CITY_STATE_FRIENDSHIP';

UPDATE Language_ko_KR
SET Text = '{TXT_KEY_UNIT_GREEK_HOPLITE}는 {TXT_KEY_UNIT_SPEARMAN}을 대체하는 그리스의 고유 유닛입니다. 아군 지상 유닛과 인접 시 더욱 강해지는데, 아군 유닛이 적에 인접해있지 않아도 됩니다.'
...
UPDATE Language_ko_KR
SET Text = '근접, 화약, 기마, 기갑 유닛이 [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_BUSHIDO}[ENDCOLOR] 승급을 얻습니다. [ICON_GREAT_GENERAL]위대한 장군 또는 [ICON_GREAT_ADMIRAL]위대한 제독이 출현할 때 [ICON_CAPITAL]수도의 [ICON_GREAT_PEOPLE]위대한 예술가/작가/음악가 점수가 50% 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '{TXT_KEY_CIV5_KOREA_HWACHA_HEADING}는 {TXT_KEY_UNIT_TREBUCHET}을 대체하는 한국의 고유 유닛입니다. 화차는 진정한 공성 무기라기보다는 대인 원거리 공격기에 가깝습니다. 공성 유닛이 가진 대부분의 보너스와 페널티가 없으며, 광역 피해를 입힙니다. 특이하게도 도시 근처에 있을 때 전투력이 [ICON_STRENGTH]만큼 증가하여 방어 및 주둔에 특히 효과적입니다. 또한 물리적 전투 능력치가 훨씬 뛰어나기 때문에 요새화나 지형 방어의 이점을 누릴 수 없고 대부분의 공성 유닛처럼 적진에서 이동 속도 감소 페널티를 받지만, 적 도시 바로 앞까지 접근할 수 있다면 공성 능력을 어느 정도 되찾을 수 있습니다!'
WHERE Tag = 'TXT_KEY_CIV5_KOREA_HWACHA_STRATEGY';

UPDATE Language_ko_KR
SET Text = '한국의 전설적인 대보병 무기인 화차는 초기 화약 무기 개발에 있어 독창적인 혁신을 가져왔습니다. 15세기 세종대왕의 감독 하에 개발된 화차는 현대의 미사일 포대와 유사한 벌집 모양의 포가를 장착한 커다란 두 바퀴 수레로 구성되어 있으며, 이 포가에는 수백 발의 화약 화살을 장전할 수 있었습니다. ''신기전''으로 알려진 이 초기 화살은 가벼워서 화차에 상당한 이점을 제공했으며, 전통적인 대포에 비해 뛰어난 기동성을 가능하게 했습니다. 화차는 16세기 일강 침략 당시 한반도 방어에 있어 막강한 위력을 발휘하는 무기였습니다.'
...
--------------------
UPDATE Language_ko_KR
SET Text = '원거리 기마 유닛이 [COLOR_POSITIVE_TEXT]병참[ENDCOLOR]과 [COLOR_POSITIVE_TEXT]위대한 장군 I[ENDCOLOR] 승급을 얻습니다. 도시 국가의 [ICON_PIRATE] 공물을 받으면, 획득한 [ICON_GOLD] 골드의 25%만큼 [ICON_CAPITAL]수도에서[ICON_PRODUCTION] 생산과 [ICON_RESEARCH] 과학을 얻습니다.'
...
--------------------
UPDATE Language_ko_KR
SET Text = '다른 문명이나 도시 국가로부터 수입 또는 수출하는 사치 자원 1종류마다 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR], [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR] 증가합니다. [COLOR_YELLOW](인공지능 또한 네덜란드의 특성으로 인한 이득을 고려합니다)[ENDCOLOR]'
...
--------------------
UPDATE Language_ko_KR
SET Text = '승선 시 [ICON_VISION] 시야가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가하고 [COLOR_POSITIVE_TEXT]대양[ENDCOLOR]을 건널 수 있습니다. 근접, 화약 유닛이 [COLOR_POSITIVE_TEXT]어선[ENDCOLOR]을 건설할 수 있습니다. 더이상 [COLOR_POSITIVE_TEXT]고립[ENDCOLOR]에서 오는 [ICON_HAPPINESS_3]불행이 증가하지 않습니다.'
...
--------------------
UPDATE Language_ko_KR
SET Text = '모든 길은 로마로 통한다'
WHERE Tag = 'TXT_KEY_TRAIT_CAPITAL_BUILDINGS_CHEAPER_SHORT';


UPDATE Language_ko_KR
SET Text = '[ICON_CAPITAL] 수도에 건설된 건물을 다른 도시에 건설할 때 [ICON_PRODUCTION] 생산 보너스를 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 제공합니다.  [ICON_CAPITAL] 수도 근처 8타일 내에 지어져 육지로 연결된 도시마다 [ICON_GOLD] 골드 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_CULTURE] 문화 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], [ICON_TOURISM] 관광 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]을 제공합니다. [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR]'
...
--------------------
UPDATE Language_ko_KR
SET Text = '야만인 주둔지를 파괴할 때 또는 도시를 약탈할 때 획득하는 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]세 배[ENDCOLOR]로 증가합니다. 지상 유닛이 [COLOR_PLAYER_PURPLE]{TXT_KEY_PROMOTION_SEWN_CANOES}[ENDCOLOR] 승급을 보유합니다.'
