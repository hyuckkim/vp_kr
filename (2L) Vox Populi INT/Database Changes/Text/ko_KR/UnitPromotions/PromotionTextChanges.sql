...
-- March
UPDATE Language_ko_KR
SET Text = '유닛이 행동 여부와 상관없이 체력을 턴당 [COLOR_POSITIVE_TEXT]10[ENDCOLOR]씩 회복합니다.'
...
-- Logistics
UPDATE Language_ko_KR
SET Text = '공격 시 [ICON_RANGE_STRENGTH]원거리 전투력 [COLOR_NEGATIVE_TEXT]-20%[ENDCOLOR][NEWLINE][COLOR_POSITIVE_TEXT]두 번[ENDCOLOR] 공격 가능'
...
-- Dogfighting
UPDATE Language_ko_KR
SET Text = '대공 무력화 수행 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+33%[ENDCOLOR][NEWLINE]'
...
UPDATE Language_ko_KR
SET Text = '대공 무력화 수행 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+34%[ENDCOLOR][NEWLINE]대공 무력화로 요격 불가 시 목표 유닛에 인접한 모든 적 공중 유닛에 피해 [COLOR_POSITIVE_TEXT]10[ENDCOLOR]'
...
UPDATE Language_ko_KR
SET Text = '유닛이 행동 여부와 상관없이 체력을 턴당 [COLOR_POSITIVE_TEXT]10[ENDCOLOR]씩 회복합니다.[ENDCOLOR][NEWLINE][ICON_RAZING] 약탈 시 [ICON_MOVES] 이동력 소모 없음.'
...
-- Altitude Training
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]언덕[ENDCOLOR]에서 [ICON_STRENGTH] 전투력 +10%.'
...
-- Naval Leadership
UPDATE Language_ko_KR
SET Text = '이 타일 근처 2타일의 해양 유닛 [ICON_STRENGTH] 전투력 +15%, 매 턴 체력 회복 [COLOR_POSITIVE_TEXT]+3[ENDCOLOR]'
...
UPDATE Language_ko_KR
SET Text = '인접한 아군 유닛마다 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+15%[ENDCOLOR]'
...
UPDATE Language_ko_KR
SET Text = '설원, 툰드라, 언덕 타일에서 [ICON_STRENGTH] 전투력 보너스 [COLOR_POSITIVE_TEXT]+25%[ENDCOLOR][NEWLINE]설원, 툰드라, 언덕 타일에서 [ICON_MOVES]이동력 [COLOR_POSITIVE_TEXT]두 배[ENDCOLOR]'
WHERE Tag = 'TXT_KEY_PROMOTION_SKI_INFANTRY_HELP';

-- Haka War Dance
UPDATE Language_ko_KR
SET Text = '인접한 적 유닛의 [ICON_STRENGTH] 전투력 보너스 [COLOR_POSITIVE_TEXT]-15%[ENDCOLOR][NEWLINE]승선과 하선에 오직 [ICON_MOVES] 이동력 1 소모'
...
-- Full Moon Striker
UPDATE Language_ko_KR
SET Text = '[ICON_MOVES] 이동력 +1[NEWLINE][ICON_RAZING] 약탈 시 [ICON_RESEARCH] 과학 200 획득'
...
-- Near Capital Bonus
UPDATE Language_ko_KR
SET Text = '[ICON_CAPITAL]수도에서 전투 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+30%[ENDCOLOR][NEWLINE]보너스는 수도에서 멀어질수록 타일 하나당 1%씩 감소 (최대 29타일)'
