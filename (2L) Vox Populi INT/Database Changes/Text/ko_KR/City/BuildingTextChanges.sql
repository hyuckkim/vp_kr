...
-- Police Station
UPDATE Language_ko_KR
SET Text = '[ICON_SPY] 도시 보안이 +10 증가하고, [ICON_CITIZEN] 시민 둘마다 1씩 추가로 증가합니다. 이 도시에서 적 [ICON_SPY] 스파이를 체포하거나 처치 시 [ICON_CULTURE] 문화 및 [ICON_RESEARCH] 과학을 100 [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_GOLD] 빈곤, [ICON_RESEARCH] 문맹, [ICON_CULTURE]무료에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다.'
WHERE Tag = 'TXT_KEY_BUILDING_POLICE_STATION_HELP';

-- Constabulary
UPDATE Language_ko_KR
SET Text = '[ICON_SPY] 도시 보안이 20 증가하고, [ICON_CITIZEN] 시민 둘마다 1씩 추가로 증가합니다. 적 스파이를 찾아내면 [ICON_CULTURE] 문화 및 [ICON_RESEARCH] 과학을 25 [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다.'
