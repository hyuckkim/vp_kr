...
-- Garden
UPDATE Language_ko_KR
SET Text = '정원은 도시에서 [ICON_GREAT_PEOPLE] 위인이 탄생하는 속도를 25% 증가시키고, 오아시스의 식량 생산을 증가시킵니다. 정원을 건설하려면 송수로가 필요합니다.'
...
-- University
UPDATE Language_ko_KR
SET Text = '대학은 중세 시대 건물입니다. 도시의 [ICON_RESEARCH] 과학을 증가시켜주며 만일 정글 또는 설원 타일 근처에 도시가 있다면 더 효과적입니다. 도시는 대학을 건설하기 위해서는 먼저 도서관을 건설해야 합니다.'
WHERE Tag = 'TXT_KEY_BUILDING_UNIVERSITY_STRATEGY';

-- Public School
UPDATE Language_ko_KR
SET Text = '공립학교는 도시 인구에 기반해 [ICON_RESEARCH] 과학을 증가시켜주는 르네상스 시대 건물입니다. 도시에 공립학교를 건설하기 위해서는 먼저 대학을 건설해야 합니다.'
...
-- Spaceship Factory
UPDATE Language_ko_KR
SET Text = '우주선 공장은 도시에서 우주선 부품 제작 속도를 증가시켜줍니다. 우주선 공장은 하나의 [ICON_RES_ALUMINUM] 알루미늄 자원을 필요로 하며, 도시는 항공우주국을 건설하기 전에 공장을 보유하여야 합니다.'
WHERE Tag = 'TXT_KEY_BUILDING_SPACESHIP_FACTORY_STRATEGY';

-- Circus
UPDATE Language_ko_KR
SET Text = '서커스 극단은 도시의 무료를 감소시키고 [ICON_RES_IVORY] 상아에 문화 보너스를 제공합니다. 또한 도시에서 10턴동안 "국왕경축일"을 시작합니다. 서커스 극단을 지어 불행을 감소시키고, 문화 폭발을 가져올 수 있습니다.'
...
-- United Nations
UPDATE Language_ko_KR
SET Text = '높은 비율의 위인 생산과 결합될 경우, 유엔은 세계 의회에서 그 소유자의 외교적 권력을 상당히 강화해줍니다. 또한 추가 대표자를 제공하고 황금기를 시작합니다.[NEWLINE][NEWLINE]이러한 즉각적인 이점 외에도 유엔의 건설은 세계 의회의 유엔 특별 회의의 시작을 촉발하여 외교적 승리를 가능하게 합니다. 세계 의회를 통해서만 협력적으로 건설될 수 있습니다.'
...
UPDATE Language_ko_KR 
SET Text = '가능한 테마 보너스:
  [NEWLINE][ICON_BULLET] [COLOR_CYAN]동시대[ENDCOLOR] [COLOR_POSITIVE_TEXT]국내[ENDCOLOR] 혹은 [COLOR_POSITIVE_TEXT]해외[ENDCOLOR]의 [ICON_GW_ART] 걸작 예술품 2개에서 [ICON_CULTURE] 문화 +6, [ICON_TOURISM] 관광 +6을 얻습니다.
  [NEWLINE][ICON_BULLET] [COLOR_CYAN]동시대[ENDCOLOR] [COLOR_POSITIVE_TEXT]국내[ENDCOLOR] 혹은 [COLOR_POSITIVE_TEXT]해외[ENDCOLOR]의 [ICON_ARTIFACT] 유물 2개에서 [ICON_CULTURE] 문화 +6, [ICON_TOURISM] 관광 +6을 얻습니다.
  [NEWLINE][ICON_BULLET] [COLOR_CYAN]동시대[ENDCOLOR] [COLOR_POSITIVE_TEXT]국내[ENDCOLOR] 혹은 [COLOR_POSITIVE_TEXT]해외[ENDCOLOR]의 [ICON_GW_ART] 걸작 예술품과 [ICON_ARTIFACT] 유물 한 쌍에서 [ICON_CULTURE] 문화 +5, [ICON_TOURISM] 관광 +5를 얻습니다.
  [NEWLINE][ICON_BULLET] [COLOR_POSITIVE_TEXT]국내[ENDCOLOR] 혹은 [COLOR_POSITIVE_TEXT]해외[ENDCOLOR]의 [ICON_GW_ART] 걸작 예술품 2개에서 [ICON_CULTURE] 문화 +5, [ICON_TOURISM] 관광 +5를 얻습니다.
  [NEWLINE][ICON_BULLET] [COLOR_POSITIVE_TEXT]국내[ENDCOLOR] 혹은 [COLOR_POSITIVE_TEXT]해외[ENDCOLOR]의 [ICON_ARTIFACT] 유물 2개에서 [ICON_CULTURE] 문화 +5, [ICON_TOURISM] 관광 +5를 얻습니다.'
