...
-- Industrialization
UPDATE Language_ko_KR
SET Text = '도시의 [ICON_PRODUCTION]생산을 크게 향상시키는 [COLOR_POSITIVE_TEXT]공장[ENDCOLOR]을 건설할 수 있습니다. 다양한 게임 후반 유닛에 사용되는 [ICON_RES_ALUMINUM] 알루미늄을 발견합니다.'
...
-- Lasers
UPDATE Language_ko_KR
SET Text = '[ICON_RES_URANIUM] 우라늄을 요구하며 유닛과 도시를 손쉽게 파괴하는 [COLOR_POSITIVE_TEXT]핵미사일[ENDCOLOR]을 생산할 수 있습니다.'
...
-- Railroad
UPDATE Language_ko_KR
SET Text = '추가 [ICON_INTERNATIONAL_TRADE][COLOR_YELLOW]교역로[ENDCOLOR]를 제공합니다. 노동자가 철도를 건설할 수 있습니다.'
...
-- Printing Press
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]인쇄국[ENDCOLOR]을 건설해 외교 유닛이 지형 이동 비용을 무시할 수 있습니다. [COLOR_POSITIVE_TEXT]세계 대회[ENDCOLOR]를 창설할 수 있습니다.'
...
-- Electricity
UPDATE Language_ko_KR
SET Text = '추가 [ICON_INTERNATIONAL_TRADE] 교역로를 제공합니다. 도시가 [COLOR_POSITIVE_TEXT]증권 거래소[ENDCOLOR]를 건설해 골드를 증가시킬 수 있게 됩니다. [COLOR_POSITIVE_TEXT]수력 발전소[ENDCOLOR]를 건설해, 강 근처의 생산을 증가시킬 수 있습니다.'
WHERE Tag = 'TXT_KEY_TECH_ELECTRICITY_HELP';

-- Radio
UPDATE Language_ko_KR
SET Text = '도시의 [ICON_CULTURE]문화를 크게 증가시키는 [COLOR_POSITIVE_TEXT]방송탑[ENDCOLOR]을 건설할 수 있습니다. 방송탑은 테마가 맞춰진 걸작의 관광을 증가시킵니다.'
