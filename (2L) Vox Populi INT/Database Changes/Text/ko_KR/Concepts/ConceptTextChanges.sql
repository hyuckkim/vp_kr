...
UPDATE Language_ko_KR
SET Text = '도시 화면 내에서 골드로 유닛을 구매하거나[COLOR_YELLOW] 건물에 골드를 투자하여 건설 비용을 줄일 수 있습니다.[ENDCOLOR] 이것은 침입자로부터 방어할 추가 유닛과 같이 급하게 무언가가 필요한 경우에 유용할 수 있습니다.'
...
-- Autocracy
UPDATE Language_ko_KR
SET Text = '[COLOR_YELLOW]전제[ENDCOLOR]'
