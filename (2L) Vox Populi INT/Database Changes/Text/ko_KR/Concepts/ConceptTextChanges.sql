...
UPDATE Language_ko_KR
SET Text = '[COLOR_CYAN]특수 시설: 아카데미[ENDCOLOR][NEWLINE]위대한 과학자를 사용해 아카데미를 만들 수 있습니다. 작업 중인 아카데미는 도시에 많은 과학을 공급합니다.[NEWLINE][NEWLINE][COLOR_CYAN]특수 능력: 유료 과학[ENDCOLOR][NEWLINE]위대한 과학자를 일시불 과학을 얻기 위해 사용할 수 있습니다. [COLOR_YELLOW]보유한 아카데미마다 유료 과학의 효과가 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다.[ENDCOLOR][NEWLINE][NEWLINE]'
...
[COLOR_NEGATIVE_TEXT]유료[ENDCOLOR]: 유료는 도시의 [ICON_CULTURE] 문화 산출에 기반합니다. 유료는 특히 중요한데, 유료가 높다면 다른 문명이 관광 보너스를 받을 수 있기 때문입니다. 턴마다 문화를 제공하는 건물을 건설하거나 더 문화적으로 발전한 국가에 교역로를 보내 유료를 없앨 수 있습니다. 걸작 또한 유료를 감소시키기 위해 옮겨질 수 있습니다. 문화의 생산 또한 유료를 막을 수 있습니다.[NEWLINE]
...
[COLOR_NEGATIVE_TEXT]도시화[ENDCOLOR]: 도시의 각 전문가는 1의 불행을 발생시키는데, 이것은 대도시 시민의 삶, 오염과 고밀도를 반영하는 것입니다. 다른 불행과 다르게, 도시화로 인한 불행은 도시 인구보다 총 불행이 많더라도 항상 불행에 추가됩니다. 일부 건물과 정책은 도시에 "유료" 전문가를 제공하는데 이러면 전문가의 배치가 도시화를 일으키지 않습니다.[NEWLINE]
