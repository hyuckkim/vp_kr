...
25%[ENDCOLOR] 증가합니다. 국경이 확장될 때 [ICON_PEACE]신앙을 [COLOR_POSITIVE_TEXT]25[ENDCOLOR], [ICON_PRODUCTION]생산을 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] 제공합니다. [COLOR:110:110:110:255](게임 속도별 보정)[ENDCOLOR]'
...
UPDATE Language_ko_KR
SET Text = '곡창의 [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR], [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 농장이 건설된 자원 타일의 [ICON_FOOD] 식량이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'
