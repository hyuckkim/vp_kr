...
-- Asceticism
UPDATE Language_ko_KR
SET Text = '신도 2명마다 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 전문가가 있는 도시의 식량이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '신도 3명마다 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.  [ICON_GREAT_WORK] 걸작의 문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '신도 2명마다 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 이 도시에서 활성화된 [ICON_INTERNATIONAL_TRADE] 교역로마다 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text =  '전문가가 [ICON_GOLDEN_AGE] 황금기 점수를 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 주요 산출량을 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 제공합니다 ([ICON_SCIENTIST]:[ICON_RESEARCH], [ICON_MERCHANT]/[ICON_CIVIL_SERVANT]:[ICON_GOLD], [ICON_ENGINEER]:[ICON_PRODUCTION], [ICON_WRITER]/[ICON_ARTIST]/[ICON_MUSICIAN]:[ICON_CULTURE]).'
...
UPDATE Language_ko_KR
SET Text = '신도 3명마다 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 대학의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '신도 2명마다 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [COLOR_POSITIVE_TEXT]보너스 자원[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[ICON_PEACE] 신앙으로 극장, 오페라 극장, 박물관, 방송탑을 구매할 수 있고, 해당 건물의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 이 종교를 따르는 도시 2개마다 성도의 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
