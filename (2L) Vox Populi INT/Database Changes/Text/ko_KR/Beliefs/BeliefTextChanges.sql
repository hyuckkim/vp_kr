...
UPDATE Language_ko_KR
SET Text = '채석장의 [ICON_PRODUCTION]생산 및 [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 궁전의 [ICON_PEACE]신앙 및 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 석재 공장의 [ICON_FAITH]신앙이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[ICON_CULTURE_LOCAL] 국경 확장 속도가 [COLOR_POSITIVE_TEXT]
25%[ENDCOLOR] 증가합니다. 국경이 확장될 때 [ICON_PEACE]신앙을 [COLOR_POSITIVE_TEXT]25[ENDCOLOR] [COLOR:110:110:110:255](게임 속도별 보정)[ENDCOLOR] [ICON_PRODUCTION]생산을 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] [COLOR:110:110:110:255](게임 속도별 보정)[ENDCOLOR] 제공합니다.'
...
-- God of War
UPDATE Language_ko_KR
SET Text = '전투 유닛을 처치 시 [ICON_PEACE]신앙을 유닛 [ICON_STRENGTH] 전투력의 175%만큼 획득합니다. 병영의 [ICON_PEACE] 신앙이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
...
-- Ceremonial Burial
UPDATE Language_ko_KR
SET Text = ' [ICON_GREAT_PEOPLE]위인을 소모할 때 당신의 [ICON_RELIGION]종교를 따르는 도시에 [COLOR:110:110:110:255](한도: 25도시)[ENDCOLOR] [ICON_PEACE]신앙 및 [ICON_CULTURE]문화를 [COLOR_POSITIVE_TEXT]10[ENDCOLOR] 제공합니다. (시대에 따라 보정) [NEWLINE][COLOR_YELLOW]마우솔레움[ENDCOLOR] 국가 불가사의를 건설할 수 있습니다. (+5 [ICON_PEACE] 신앙, 전투로 인해 유닛이 사망 시 [ICON_PEACE] 신앙, [ICON_RELIGION]성지에서  +5 [ICON_PEACE] 신앙; [COLOR_POSITIVE_TEXT]개혁 교리[ENDCOLOR]를 선택할 수 있습니다.)'
