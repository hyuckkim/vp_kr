...
UPDATE Language_ko_KR
SET Text = '고대 시대 이후 매 시대마다 이 자연 경관의 [ICON_RESEARCH]과학이 +2 증가합니다.[NEWLINE][NEWLINE]크라카타우는 인도네시아의 자바 섬과 수마트라 섬 사이에 위치한 화산섬입니다. 1883년 8월 히로시마에 투하된 원폭의 13000배의 파괴력을 가진 화산이 폭발하여 섬의 절반을 쓸어버렸습니다. 이때의 폭발음이 3,500km 떨어진 호주에서도 들렸다고 합니다. 화산 폭발과 뒤를 이은 해일로 인해 37,000명 가량의 사람들이 목숨을 잃었습니다. 지난 8년간 화산은 꾸준히 용암을 뱉어내고 있으며 연간 약 4.7.3m 정도의 속도로 다시 쌓이고 있습니다.'
