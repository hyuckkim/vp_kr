...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외교국[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_SPY_POINT] 스파이 점수를 100 제공합니다.[NEWLINE][ICON_BULLET] 위대한 외교관의 출현율이 50% 증가합니다.[NEWLINE][ICON_BULLET] 도시 국가의 퀘스트 보상이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]보조금[ENDCOLOR][NEWLINE][ICON_BULLET] 무료 석탄을 4개 얻습니다. [NEWLINE][ICON_BULLET]건물 건설을 완료할 때마다 [ICON_RESEARCH] 과학이 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] 증가합니다.[COLOR:105:105:105:255](시대별 보정)[ENDCOLOR][NEWLINE][ICON_BULLET]풍차의 [ICON_HAPPINESS_1] 행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
