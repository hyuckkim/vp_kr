...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]노동 분업[ENDCOLOR][NEWLINE][NEWLINE][ICON_BULLET]모든 대장간, 풍차, 작업장, 공장, 석탄 저장소의 [ICON_PRODUCTION]생산 및 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] 증가합니다.[NEWLINE][ICON_BULLET]석탄 저장소 건설 시 +100%의 [ICON_PRODUCTION]생산 보너스를 얻습니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]보호무역주의[ENDCOLOR][NEWLINE][ICON_BULLET]건물에 투자하는 [ICON_INVEST] 골드가 [ICON_PRODUCTION]생산 비용을 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 더 감소시킵니다. [NEWLINE][ICON_BULLET]국제 교역로의 산출량이 [COLOR_POSITIVE_TEXT]33%[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]"국왕 경축일"이 열리는 동안 [ICON_FOOD]식량 및 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다.'
