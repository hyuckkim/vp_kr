...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]지배[ENDCOLOR][NEWLINE][ICON_BULLET]적 군사 유닛을 처치할 때 처치한 유닛의 [ICON_STRENGTH]전투력의 100% 만큼 [ICON_RESEARCH]과학을 제공합니다. [NEWLINE][ICON_BULLET]근접 유닛이 적 군사 유닛을 처치할 때 체력을 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] 회복합니다. [NEWLINE][ICON_BULLET][ICON_SILVER_FIST] 인구수에 따른 군사 유닛 보급 한도가 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]보호무역주의[ENDCOLOR][NEWLINE] 건물에 투자하는 [ICON_INVEST] 골드가 [ICON_PRODUCTION]생산 비용을 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 더 감소시킵니다. [NEWLINE][ICON_BULLET]국제 교역로의 산출량이 [COLOR_POSITIVE_TEXT]33%[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]"국왕 경축일"이 열리는 동안 [ICON_FOOD]식량 및 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]조약 기구[ENDCOLOR]: [ICON_INTERNATIONAL_TRADE]교역로가 연결된 도시 국가 1개마다 [COLOR:105:105:105:255](한도: 10)[ENDCOLOR] 해당 도시 국가에 대한 [ICON_INFLUENCE]영향력이 매 턴 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 세계의 원래 도시 국가 4개마다 세계 대회 추가 [ICON_DIPLOMAT]대표단을 1명 확보합니다.'
