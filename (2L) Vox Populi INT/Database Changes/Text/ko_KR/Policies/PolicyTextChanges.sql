...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]노동 분업[ENDCOLOR][NEWLINE][NEWLINE][ICON_BULLET]모든 대장간, 풍차, 작업장, 공장, 석탄 저장소의 [ICON_PRODUCTION]생산 및 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] 증가합니다. [ICON_BULLET]석탄 저장소 건설 시 +100%의 [ICON_PRODUCTION]생산 보너스를 얻습니다.'
