...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]정의[ENDCOLOR][NEWLINE][ICON_BULLET]유닛이 주둔한 도시의 [ICON_RANGE_STRENGTH]원거리 전투력이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET][ICON_CAPITAL]수도에 [COLOR_YELLOW]{TXT_KEY_BUILDING_ROYAL_GUARDHOUSE}[ENDCOLOR]가 출현합니다. ([ICON_PRODUCTION]생산 +3, [ICON_STRENGTH]방어력 +3, 체력 +50, 군사 유닛 보급 한도가 시민의 20%만큼 증가, 모든 자문회와 대장간의 [ICON_PRODUCTION] 생산 +1, [ICON_ENGINEER] 기술자 슬롯 +1)'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]주권[ENDCOLOR] [NEWLINE][ICON_BULLET][ICON_CAPITAL] 수도에 [COLOR_YELLOW]{TXT_KEY_BUILDING_COURT_CHAPEL}[ENDCOLOR]이 출현합니다.([ICON_PEACE] 신앙 +3, [ICON_CULTURE_LOCAL] 국경 확장 점수 +100%, 모든 기념비와 사원의 [ICON_CULTURE_LOCAL] 국경 확장 점수 +5, [ICON_GREAT_WORK] 걸작 예술품 또는 유물 슬롯 +1, [ICON_ARTIST] 예술가 슬롯 +1)'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]진보[ENDCOLOR]는 [COLOR_CYAN]게임 초반[ENDCOLOR]에 자급자족이 가능한 도시들을 확장하고, 무료 산출량과 더 빠른 [ICON_WORKER] 타일 시설 건설 속도를 확보하는 데 중점을 둡니다. 건물 건설과 [ICON_CITIZEN] 시민의 탄생은 [COLOR_CYAN]게임 전반[ENDCOLOR]에 걸쳐 경제를 뒷받침합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]정책 개방 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET]즉시 75 [ICON_RESEARCH] 과학을 획득합니다.[NEWLINE][ICON_BULLET][ICON_CITIZEN] 시민이 태어날 때마다 8 [ICON_RESEARCH] 과학을 획득하며, 이는 시대에 비례해 증가합니다.[NEWLINE][ICON_BULLET]기술 연구 시 15 [ICON_CULTURE] 문화를 획득하며[COLOR:105:105:105:255](시대별 보정)[ENDCOLOR], 이미 연구를 완료한 기술 하나마다 [ICON_CULTURE] 문화를 15 얻습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]각 정책 채택 보너스:[ENDCOLOR] [NEWLINE][ICON_BULLET]기술 발견 시 [ICON_CULTURE] 문화 15 [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR][NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]계열 완성 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]자금성[ENDCOLOR] 불가사의 건설 가능[NEWLINE][ICON_BULLET][ICON_CITIZEN] 시민이 태어날 때 [ICON_GOLD] 골드 25 [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR][NEWLINE][ICON_BULLET]산업 시대 이후 [ICON_PEACE] 신앙으로 [ICON_GREAT_WRITER][COLOR_YELLOW]위대한 작가[ENDCOLOR] 구매 가능'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]권위[ENDCOLOR]는 [COLOR_CYAN]게임 초반[ENDCOLOR]부터 상비군을 유지하고 이를 [ICON_SILVER_FIST] 무력으로 전환하도록 준비합니다. [COLOR_CYAN]게임 전반[ENDCOLOR]에 걸쳐 [ICON_CULTURE_LOCAL] 국경 확장과 [ICON_WAR] 전쟁을 통한 유닛 처치로 상당한 산출량을 얻습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]정책 개방 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET]야만인 대항 전투력 보너스 +25%[NEWLINE][ICON_BULLET]야만인 주둔지 출현 시 알람 및 파괴 시 [ICON_CULTURE] 문화 25 [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR][NEWLINE][ICON_BULLET]적 유닛 처치 시 [ICON_STRENGTH] 전투력의 50%만큼 [ICON_CULTURE]문화 및 [ICON_RESEARCH] 과학 획득[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]각 정책 채택 보너스:[ENDCOLOR] [NEWLINE][ICON_BULLET]적 유닛 처치 시 [ICON_STRENGTH] 전투력의 10%만큼 [ICON_CULTURE]문화 및 [ICON_RESEARCH] 과학 획득[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]계열 완성 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]알함브라 궁전[ENDCOLOR] 불가사의 건설 가능[NEWLINE][ICON_BULLET] 국경 확장 시 권위 정책 보너스 두 배[NEWLINE][ICON_BULLET][COLOR_YELLOW]자유용병대[ENDCOLOR], [COLOR_YELLOW]외인부대[ENDCOLOR], [COLOR_YELLOW]용병[ENDCOLOR] 구매 가능[NEWLINE][ICON_BULLET]산업 시대 이후 [ICON_PEACE]신앙으로 [ICON_GREAT_GENERAL][COLOR_YELLOW]위대한 장군[ENDCOLOR] 구매 가능'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]공물[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_CAPITAL]수도 근처에 무료 [COLOR_YELLOW]개척자[ENDCOLOR]가 1명 출현합니다. [NEWLINE][ICON_BULLET] [ICON_CITY_STATE] 도시 국가에 요구하는 골드 공물의 25%에 해당하는 [ICON_CULTURE] 문화를 수도에서 획득합니다. ([COLOR_YELLOW]모든 {TXT_KEY_POLICY_BRANCH_HONOR} 정책을 채택한 경우 50%[ENDCOLOR])'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]지배[ENDCOLOR][NEWLINE][ICON_BULLET]모든 근접 유닛이 [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_ENDURANCE}[ENDCOLOR] 승급을 얻습니다. (적 군사 유닛을 처치할 때 체력을 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] 회복)[ICON_BULLET] 전략 자원의 [ICON_PRODUCTION] 생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] [ICON_CULTURE_LOCAL] 국경 확장 점수가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET][ICON_SILVER_FIST] 인구수에 따른 군사 유닛 보급 한도가 [COLOR_POSITIVE_TEXT]5[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]신성한 권리[ENDCOLOR][NEWLINE][ICON_BULLET]제국의 군사 유닛 10개마다 [ICON_HAPPINESS_1] 행복이 +1 증가합니다. [NEWLINE][ICON_BULLET]"국왕 경축일"이 열리는 동안 도시의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가하고 [ICON_CULTURE_LOCAL] 국경 확장 속도가 100% 증가합니다. '
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외교[ENDCOLOR]는 [ICON_DIPLOMAT] 세계 의회의 주도권을 장악하기 위해 [ICON_CITY_STATE] 도시 국가와의 [ICON_INFLUENCE] 영향력을 높이는 데 집중합니다. 외교 유닛과 도시 국가 퀘스트 보상이 강화되며, [ICON_INTERNATIONAL_TRADE] 교역로와 [ICON_SPY] 스파이의 효율도 높아집니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]정책 개방 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET]전역 [ICON_CITIZEN]시민 20명마다 [ICON_CAPITAL]수도의 모든 산출량 +1[NEWLINE][ICON_BULLET]모든 도시의 [ICON_GOLD]골드 +1[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]각 정책 채택 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET]{TXT_KEY_POP_CSTATE_GIFT_GOLD}의 [ICON_INFLUENCE]영향력 +10%[NEWLINE][ICON_BULLET]모든 도시의 [ICON_GOLD]골드 +1[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]계열 완성 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]웨스트민스터 궁전[ENDCOLOR] 불가사의 건설 가능[NEWLINE][ICON_BULLET]세계 대회가 열릴 때마다 확보한 [ICON_DIPLOMAT]대표단 수마다 [ICON_CULTURE]문화, [ICON_RESEARCH]과학, [ICON_GOLD]골드 5 제공 [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR][NEWLINE][ICON_BULLET]동맹인 [ICON_CITY_STATE]도시 국가 3개마다 [ICON_WONDER] 불가사의 건설에 필요한 정책 수 -1'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외교국[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_SPY_POINT] 스파이 포인트를 100 제공합니다.[NEWLINE][ICON_BULLET] 위대한 외교관의 출현율이 50% 증가합니다.[NEWLINE][ICON_BULLET] 도시 국가의 퀘스트 보상이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]그림자 네트워크[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_SPY_POINT] 스파이 포인트 100마다 [ICON_CAPITAL]수도의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] [COLOR:105:105:105:255](한도: 30%)[ENDCOLOR] 증가합니다.[NEWLINE][ICON_BULLET]모든 전문가의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]모든 외교 청사 및 경찰대 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외환 시장[ENDCOLOR][NEWLINE][ICON_BULLET]추가 [ICON_INTERNATIONAL_TRADE][COLOR_YELLOW]교역로[ENDCOLOR]를 1개 제공합니다.[NEWLINE][ICON_BULLET][ICON_CITY_STATE]도시 국가가 제공하는 자원이 독점에 계산 됩니다.[NEWLINE][ICON_BULLET]교역로를 연결할 때 관광이 15% 증가합니다.[NEWLINE][ICON_BULLET] 유지하는 [ICON_CITY_STATE]도시 국가 동맹 3개 마다 모든 전략 자원이 +1씩 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]무역연합[ENDCOLOR][NEWLINE][ICON_BULLET]모든 국제 [ICON_INTERNATIONAL_TRADE]교역로의 산출량이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다.[NEWLINE][ICON_BULLET]교역로 1개마다 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET][ICON_INTERNATIONAL_TRADE]교역로가 연결된 [ICON_CITY_STATE]도시 국가와의 [ICON_INFLUENCE]영향력이 매 턴 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] [COLOR:105:105:105:255](한도: 5)[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]미학[ENDCOLOR]은 [ICON_GREAT_WORK] 걸작과 [ICON_WONDER] 불가사의로부터 추가 산출량을 얻는 데 특화되어 있습니다. 문화적 [ICON_GREAT_PEOPLE] 위인의 탄생을 앞당기며, 더 길고 강력한 [ICON_GOLDEN_AGE] 황금기를 누리게 해줍니다. 또한 새로운 [COLOR_POSITIVE_TEXT]역사적 사건[ENDCOLOR]을 통해 더 높은 단계의 [ICON_TOURISM] 문화적 영향력을 확보할 수 있습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]정책 개방 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET]모든 도시의 위대한 [ICON_GREAT_WRITER] 작가, [ICON_GREAT_ARTIST] 예술가, [ICON_GREAT_MUSICIAN]음악가 출현율 +25%[NEWLINE][ICON_BULLET][ICON_GOLDEN_AGE] 황금기 동안 [ICON_CULTURE] 문화 +10%.[NEWLINE][ICON_BULLET]모든 길드 건설 시 [ICON_PRODUCTION]생산 보너스 +100%[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]각 정책 채택 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET]모든 도시의 [ICON_RESEARCH]과학 +1[NEWLINE][ICON_BULLET]각 도시의 과잉 [ICON_HAPPINESS_1] 행복의 +20%가 [ICON_GOLDEN_AGE] 황금기 점수에 추가됨[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]계열 완성 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]루브르 박물관[ENDCOLOR] 불가사의 건설 가능[NEWLINE][ICON_BULLET][ICON_RES_ARTIFACTS] 사적지 발굴 또는 [ICON_GOLDEN_AGE]황금기 시작 시 [COLOR_POSITIVE_TEXT]역사적 사건[ENDCOLOR] 발동[NEWLINE][ICON_BULLET]숨겨진 사적지 발굴 가능[NEWLINE][ICON_BULLET]랜드마크와 유물의 [ICON_RESEARCH]과학+3[NEWLINE][ICON_BULLET]산업 시대 이후 [ICON_PEACE]신앙으로 [ICON_GREAT_MUSICIAN][COLOR_YELLOW]위대한 음악가[ENDCOLOR] 구매 가능'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문화유산[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_GW_MUSIC] 걸작 음악의 [ICON_GOLD] 골드가 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]극장, 갤러리, 오페라 하우스의 [ICON_CULTURE] 문화 및 [ICON_PRODUCTION] 생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET][ICON_WONDER] 세계 불가사의, 타일의 [ICON_CULTURE] 문화의 25%가 도시의 [ICON_TOURISM] 관광에 추가됩니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]국보[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_CAPITAL]수도 근처에 원하는 [ICON_GREAT_PEOPLE][COLOR_YELLOW]위인[ENDCOLOR]이 1명 출현합니다. [NEWLINE][ICON_BULLET][ICON_GREAT_PEOPLE] 위인을 소모할 때마다 [ICON_GOLD] 골드를 [ICON_GOLD]50[ENDCOLOR] 얻습니다. [NEWLINE][ICON_BULLET][ICON_WONDER] 세계 불가사의를 건설할 때 [ICON_GOLD]골드를 [COLOR_POSITIVE_TEXT]250[ENDCOLOR] [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR] 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문화 교류[ENDCOLOR][NEWLINE][ICON_BULLET]도시의 [ICON_GREAT_WORK] 걸작 3개마다 [ICON_HAPPINESS_1] 행복이 1 증가합니다. [NEWLINE][ICON_BULLET]다른 문명과의 국경 개방에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]모든 [ICON_TOURISM]/[ICON_CULTURE] 테마 보너스가 50% 증가합니다. '
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]산업[ENDCOLOR]은 제국의 [ICON_GOLD]골드 및 [ICON_PRODUCTION]생산에 초점을 맞춘 보너스를 제공합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]정책 개방 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET]구매에 필요한 [ICON_INVEST] 골드 비용 -10%[NEWLINE][ICON_BULLET]석탄 저장소 건설 시 [ICON_PRODUCTION]생산 보너스 +100%[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]각 정책 채택 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET]구매에 필요한 [ICON_INVEST] 골드 비용 -5%[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]계열 완성 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_YELLOW]브로드웨이[ENDCOLOR] 불가사의 건설 가능[NEWLINE][ICON_BULLET]모든 사치 자원당 [ICON_HAPPINESS_1]행복 +3[NEWLINE][ICON_BULLET]보너스 자원의 [ICON_RESEARCH] 과학 +2 [ICON_PRODUCTION]생산 +1[NEWLINE][ICON_BULLET]산업 시대 이후 [ICON_PEACE]신앙으로 [ICON_GREAT_MERCHANT][COLOR_YELLOW]위대한 상인[ENDCOLOR] 구매 가능'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]노동 분업[ENDCOLOR][NEWLINE][ICON_BULLET]모든 풍차, 작업장, 공장, 석탄 저장소의 [ICON_PRODUCTION]생산 및 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.[NEWLINE][ICON_BULLET][ICON_INTERNATIONAL_TRADE] 국제 교역로마다 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]5[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]보조금[ENDCOLOR][NEWLINE][ICON_BULLET] 무료 [ICON_COAL] 석탄을 4개 얻습니다. [NEWLINE][ICON_BULLET]건물 건설을 완료할 때마다 [ICON_RESEARCH] 과학이 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] 증가합니다.[COLOR:105:105:105:255](시대별 보정)[ENDCOLOR][NEWLINE][ICON_BULLET]풍차의 [ICON_HAPPINESS_1] 행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
WHERE Tag = 'TXT_KEY_POLICY_CARAVANS_HELP';

UPDATE Language_ko_KR
SET Text = '보조금이란 특정 산업 분야의 기업이나 전체 산업의 경쟁력을 높이기 위해 정부가 재화 또는 서비스 생산자나 판매자에게 제공하는 모든 재정 지원을 말합니다. 고용 보조금은 위기 상황에서 일자리를 보호하는 데 사용될 수 있고, 운송 보조금은 새로운 운송 경로를 개설하는 데 도움이 될 수 있으며, 수출 보조금은 중상주의 정책을 추진하는 데 활용될 수 있습니다.'
WHERE Tag = 'TXT_KEY_POLICY_CARAVANS_TEXT';

UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]중상주의[ENDCOLOR][NEWLINE][ICON_BULLET]모든 세관, 은행, 증권거래소, 호텔의 [ICON_RESEARCH]과학 및 [ICON_GOLD] 골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.[NEWLINE][ICON_BULLET] [ICON_INTERNATIONAL_TRADE] 교역로 슬롯을 2개 얻습니다.'
WHERE Tag = 'TXT_KEY_POLICY_MERCANTILISM_HELP';

UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]기업가 정신[ENDCOLOR][NEWLINE][ICON_BULLET]모든 [COLOR_POSITIVE_TEXT]농장[ENDCOLOR], [COLOR_POSITIVE_TEXT]광산[ENDCOLOR], [COLOR_POSITIVE_TEXT]제재소[ENDCOLOR]에서 2 [ICON_PRODUCTION] 생산과 1 [ICON_GOLD] 금을 추가로 획득합니다.[NEWLINE][ICON_BULLET]모든 [COLOR_POSITIVE_TEXT]마을[ENDCOLOR]에서 2 [ICON_GOLD] 금과 1 [ICON_CULTURE] 문화를 추가로 획득합니다.[NEWLINE][ICON_BULLET]모든 [COLOR_POSITIVE_TEXT]도시[ENDCOLOR]에서 3 [ICON_FOOD] 식량과 3 [ICON_CULTURE] 문화를 추가로 획득합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]금본위제[ENDCOLOR][NEWLINE][ICON_BULLET]건물에 [ICON_INVEST] 금을 투자할 때 [ICON_PRODUCTION] 생산 비용이 추가로 10% 더 감소합니다.[NEWLINE][ICON_BULLET][COLOR_POSITIVE_TEXT]국왕 경축일[ENDCOLOR]이 진행 중인 도시에서 10%의 [ICON_GOLD] 금과 [ICON_CULTURE] 문화를 추가로 획득합니다.[NEWLINE][ICON_BULLET]위대한 [ICON_GREAT_MERCHANT] 상인을 소모하여 얻는 일시불 산출량이 25% 증가합니다.'
WHERE Tag = 'TXT_KEY_POLICY_PROTECTIONISM_HELP';

UPDATE Language_ko_KR
SET Text = '역사적으로 귀금속은 (상품)화폐의 기반을 형성해 왔습니다. 거액의 거래가 보편화됨에 따라 지폐와 증서 형태의 대표화폐가 주요 교환 수단으로 자리 잡았습니다. 이러한 맥락에서 금본위제는 대표화폐가 정해진 양의 금괴로 교환될 수 있는 통화 체계입니다. 이는 환율 안정과 인플레이션 억제를 위해 도입되었지만, 이러한 효과가 보장되는 것은 아니며 금본위제 도입은 통화 정책에 중대한 영향을 미칩니다. 금본위제는 1870년대부터 1920년대 초까지, 그리고 세계 기축통화인 미국 달러가 태환 정책을 종료한 1971년까지 간헐적으로 국제 통화 체계의 기반이 되었습니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]제국주의[ENDCOLOR]는 [COLOR_POSITIVE_TEXT]요새[ENDCOLOR], 군사 건물, 해상 타일 산출량을 높이고 [ICON_PUPPET] 괴뢰 도시 보너스를 제공합니다. 유닛 확보 비용을 낮추고 [ICON_GREAT_ADMIRAL] 제독과 해군의 전투 효율을 강화합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]제국주의 채택:[ENDCOLOR][NEWLINE][ICON_BULLET]해상·승선 유닛, [ICON_GREAT_GENERAL] 장군 [ICON_MOVES] 이동력 +1[NEWLINE][ICON_BULLET]근접·정찰·근접 해상·화약 유닛 [ICON_VISION] 시야 +1[NEWLINE][ICON_BULLET]군사 유닛 건설 시 [ICON_PRODUCTION] 생산 +10%[NEWLINE][ICON_BULLET]군사 유닛 업그레이드 [ICON_GOLD] 금 비용 -10%[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]각 정책 채택:[ENDCOLOR][NEWLINE][ICON_BULLET]군사 유닛 [ICON_PRODUCTION] 생산 +5%, 업그레이드 비용 -5%[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]제국주의 완성:[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_POSITIVE_TEXT]펜타곤[ENDCOLOR] 건설 가능[NEWLINE][ICON_BULLET]모든 해상·공군 유닛에 [COLOR_POSITIVE_TEXT]반자이![ENDCOLOR] 승급 부여[NEWLINE][ICON_BULLET]산업 시대부터 [ICON_PEACE] 신앙으로 [ICON_GREAT_ADMIRAL] 제독 구매 가능'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]계엄령[ENDCOLOR][NEWLINE][ICON_BULLET]도시에 주둔한 유닛의 [ICON_GOLD] 유지비가 들지 않습니다.[NEWLINE][ICON_BULLET]유닛이 주둔 중인 도시에서 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] [ICON_HAPPINESS_1] 행복과 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] [ICON_CULTURE] 문화를 추가로 획득합니다.[NEWLINE][ICON_BULLET][ICON_PUPPET] 괴뢰 도시의 산출량 및 보급량 페널티가 20% 감소합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]착취[ENDCOLOR][NEWLINE][ICON_BULLET]사치 자원의 [ICON_FOOD]식량, [ICON_PRODUCTION]생산, [ICON_GOLD] 골드가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]모든 대양, 해안, 호수 타일의 [ICON_RESEARCH]과학 및 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]식민주의[ENDCOLOR][NEWLINE][ICON_BULLET]무기고, 사관 학교, 성형 요새, 요새의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]성채의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET][ICON_MONOPOLY] 글로벌 독점에서 오는 [ICON_GOLDEN_AGE]산출량이 비율 기반이면 [COLOR_POSITIVE_TEXT]5%[ENDCOLOR], 아니면 [COLOR_POSITIVE_TEXT]5[ENDCOLOR] 증가합니다. '
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문명화 사명[ENDCOLOR][NEWLINE][ICON_BULLET]도시를 점령했을 때 모든 건물이 유지됩니다.[NEWLINE][ICON_BULLET]도시를 점령할 때 [ICON_GOLD]골드를 75 제공합니다. (시대와 도시의 인구수에 따라 보정) [NEWLINE][ICON_BULLET]건물 건설 시 현재 시대와 건물 시대의 [COLOR_POSITIVE_TEXT]차이[ENDCOLOR]만큼 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]합리주의[ENDCOLOR]는 [ICON_FOOD] 인구 성장과 [ICON_HAPPINESS_1] 행복을 높여 [ICON_CITIZEN] 시민을 늘리고, [ICON_GOLDEN_AGE] 황금기와 [ICON_SCIENTIST] 과학자의 효율을 극대화합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]합리주의 채택:[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_SCIENTIST] 과학자로부터 1 [ICON_RESEARCH] 과학, 1 [ICON_CULTURE] 문화 획득[NEWLINE][ICON_BULLET][ICON_GREAT_SCIENTIST] 위대한 과학자 출현 속도 +33%[NEWLINE][ICON_BULLET]모든 도시 [ICON_FOOD] 인구 성장률 +10%[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]각 정책 채택:[ENDCOLOR][NEWLINE][ICON_BULLET]모든 도시 [ICON_FOOD] 인구 성장률 +5%[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]합리주의 완성:[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_POSITIVE_TEXT]블레츨리 파크[ENDCOLOR] 건설 가능[NEWLINE][ICON_BULLET]위대한 [ICON_GREAT_SCIENTIST] 과학자 소모 산출량 +25%[NEWLINE][ICON_BULLET]모든 도시 [ICON_SPY] 도시 보안 +12[NEWLINE][ICON_BULLET]산업 시대부터 [ICON_PEACE] 신앙으로 위대한 과학자 구매 가능'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]의무 교육[ENDCOLOR][NEWLINE][ICON_BULLET][COLOR_POSITIVE_TEXT]무료 기술[ENDCOLOR]을 1개 획득합니다.[NEWLINE][ICON_BULLET]공립학교 건설 시 100%의 [ICON_PRODUCTION] 생산력 보너스를 받습니다.[NEWLINE][ICON_BULLET]공립학교에서 [ICON_HAPPINESS_1] 행복 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], [ICON_CULTURE] 문화 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_FOOD] 식량 [COLOR_POSITIVE_TEXT]3[ENDCOLOR]을 추가로 얻습니다.'
WHERE Tag = 'TXT_KEY_POLICY_HUMANISM_HELP';

UPDATE Language_ko_KR
SET Text = '스파르타에서는 6~7세 소년들이 집을 떠나 군사학교로 보내졌습니다. 그러나 18세기에 이르러서는 학교에 다니는 아이들은 소수에 불과했고, 그마저도 1년에 3~4개월 정도밖에 다니지 못했습니다. 1763년 프로이센은 근대적인 의무교육 제도를 도입했고, 이 정책은 북유럽 전역으로 빠르게 확산되었습니다. 하지만 산업 강국이었던 영국은 교육받고 참정권을 얻은 노동계급에 위협을 느껴 1870년이 되어서야 의무교육을 도입했습니다. 자유주의자들과 교회의 아동 노동 반대 운동에도 불구하고, 영국은 의무교육을 도입하지 않았고, 그마저도 12세까지만 제공되었습니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]세속주의[ENDCOLOR][NEWLINE][ICON_BULLET]모든 전문가로부터 [ICON_GOLD] 골드 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]와 [ICON_PRODUCTION] 생산 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]을 추가로 획득합니다.[NEWLINE][ICON_BULLET][ICON_GOLDEN_AGE] 황금기가 진행되는 동안 [ICON_GREAT_PEOPLE] 위인의 출현율이 25% 증가합니다.'
WHERE Tag = 'TXT_KEY_POLICY_SCIENTIFIC_REVOLUTION_HELP';

UPDATE Language_ko_KR
SET Text = '철학자 존 로크는 사회 계약론에 기반한 독자적인 전통으로서 자유주의를 창시한 인물로 널리 알려져 있으며, 그는 모든 인간은 생명, 자유, 재산에 대한 천부적 권리를 가지며 정부는 이러한 권리를 침해해서는 안 된다고 주장했다. 1688년 명예혁명부터 1700년대 후반의 미국 혁명과 프랑스 혁명, 그리고 1839년 오스만 제국의 탄지마트 개혁에 이르기까지, 자유주의 철학은 왕권의 무력 전복과 입헌주의의 부상을 정당화하는 데 이용되었다.'
WHERE Tag = 'TXT_KEY_POLICY_FREETHOUGHT_TEXT';

UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]세속주의[ENDCOLOR][NEWLINE][ICON_BULLET]모든 도시의 종교 분쟁으로 인한 [ICON_HAPPINESS_3] 불행이 [COLOR_POSITIVE_TEXT]5[ENDCOLOR] 감소합니다.[NEWLINE][ICON_BULLET][ICON_GOLDEN_AGE] 황금기가 진행되는 동안 10%의 [ICON_RESEARCH] 과학을 추가로 획득합니다.[NEWLINE][ICON_BULLET]모든 아카데미 시설에서 추가로 [ICON_PRODUCTION] 생산 및 [ICON_GOLD] 골드를 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 얻습니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]노예 해방[ENDCOLOR][NEWLINE][ICON_BULLET]제국 내의 모든 [ICON_CITIZEN] 시민 1명당 [ICON_CULTURE] 문화 [COLOR_POSITIVE_TEXT]5[ENDCOLOR]와 [ICON_GOLDEN_AGE] 황금기 점수 [COLOR_POSITIVE_TEXT]5[ENDCOLOR]를 즉시 획득합니다. [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_GOLDEN_AGE] 황금기가 진행되는 동안 모든 도시에서 10%의 [ICON_FOOD] 식량을 추가로 얻습니다.[NEWLINE][ICON_BULLET]모든 동물원, 호텔, 박물관에서 [ICON_HAPPINESS_1] 행복 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]을 추가로 획득합니다.'
WHERE Tag = 'TXT_KEY_POLICY_SOVEREIGNTY_HELP';

UPDATE Language_ko_KR
SET Text = '1850년대에 이르러 영국 제국에서 노예 제도가 폐지된 지 거의 반세기가 지났음에도 불구하고, 자유주의적 합리주의의 보루로 자처하던 미국은 여전히 ​​재산을 소유한 백인 남성에게만 기본권을 부여하고 있었습니다. 이는 심각한 갈등을 야기했고, 결국 1861년 남북 전쟁으로 이어졌습니다. 이러한 상황 속에서 에이브러햄 링컨 대통령은 다음과 같은 행정 명령을 발표했습니다. "...주후 1863년 1월 1일부터, 당시 미국에 반란을 일으킨 주 또는 지정된 지역 내의 모든 노예는 그 날부터 영원히 자유로워진다..."'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]고용법[ENDCOLOR][NEWLINE][ICON_BULLET]전문가가 아닌 [ICON_CITIZEN] 시민 2명당 1 [ICON_PRODUCTION] 생산을 추가로 획득합니다.[NEWLINE][ICON_BULLET]전문가가 소비하는 [ICON_FOOD] 식량이 1 감소합니다. (최소 1 [ICON_FOOD] 식량)[NEWLINE][ICON_BULLET]각 도시가 보유한 [ICON_HAPPINESS_1] 행복의 50%가 [ICON_CULTURE] 문화로 전환됩니다.'
WHERE Tag = 'TXT_KEY_POLICY_FREE_THOUGHT_HELP';

UPDATE Language_ko_KR
SET TEXT = '함무라비 법전(기원전 1755-1750년경)은 조선업자와 선주 간의 고용 계약에 따라 건조된 60구르(300부셸) 선박 한 척당 2셰켈의 적정 임금을 규정했습니다. 이후 무역 보호는 법률의 핵심적인 부분이 되었습니다. 그러나 산업혁명의 참혹한 결과 중 하나는 이러한 규범이 뒤집히고 거의 규제되지 않은 경제 구조가 조성되어 수많은 고통과 죽음을 초래했다는 점입니다. 영국에서는 1833년 공장법(Factories Act)이 노동법에 있어 중요한 이정표를 세웠는데, 이 법은 18세 미만 아동의 고용을 제한하고 야간 작업을 전면 금지했으며, 무엇보다 중요한 것은 법 집행을 위한 감독관을 두도록 규정했다는 점입니다.'
WHERE Tag = 'TXT_KEY_POLICY_FREE_THOUGHT_TEXT';
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]독창적 표현[ENDCOLOR]: 모든 [ICON_GREAT_WORK]걸작에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 모든 박물관, 방송탑, 오페라 극장, 극장의 [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]제삼의 수단[ENDCOLOR]: 문명이 생산하는 전략 자원([ICON_RES_PAPER] 종이 포함)의 양이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다. 유닛 [ICON_GOLD] 유지비가 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 감소합니다.'
