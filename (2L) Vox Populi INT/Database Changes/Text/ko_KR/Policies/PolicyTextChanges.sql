...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외환 시장[ENDCOLOR][NEWLINE][ICON_BULLET]추가 [ICON_INTERNATIONAL_TRADE][COLOR_YELLOW]교역로[ENDCOLOR]를 1개 제공합니다.[NEWLINE][ICON_BULLET][ICON_CITY_STATE]도시 국가가 제공하는 자원이 독점에 계산 됩니다.[NEWLINE][ICON_BULLET]교역로를 연결할때 관광이 15% 증가합니다.[NEWLINE][ICON_BULLET] 유지하는 도시 국가 동맹 3개 마다 모든 전략 자원이 +1씩 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문화 교류[ENDCOLOR][NEWLINE][ICON_BULLET]도시의 [ICON_GREAT_WORK] 걸작 3개마다 [ICON_HAPPINESS_1] 행복이 1 증가합니다. [NEWLINE][ICON_BULLET]다른 문명과의 국경 개방에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다. [NEWLINE][ICON_BULLET]모든 극장, 갤러리 및 오페라 극장의 [ICON_CULTURE]문화 및 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]보조금[ENDCOLOR][NEWLINE][ICON_BULLET] 교역로의 유지비가  [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 감소합니다. [NEWLINE][ICON_BULLET]건물 건설을 완료할 때마다 [ICON_RESEARCH] 과학이 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] 증가합니다.[COLOR:105:105:105:255](시대별 보정)[ENDCOLOR][NEWLINE][ICON_BULLET]풍차의 [ICON_HAPPINESS_1] 행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]자유주의[ENDCOLOR][NEWLINE][ICON_BULLET]모든 전문가로부터 [ICON_GOLD] 골드 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]와 [ICON_PRODUCTION] 생산 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]을 추가로 획득합니다.[NEWLINE][ICON_BULLET][ICON_GOLDEN_AGE] 황금기가 진행되는 동안 [ICON_GREAT_PEOPLE] 위인의 출현율이 25% 증가합니다.'
