...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]천부인권[ENDCOLOR][NEWLINE][ICON_BULLET]시민마다 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하고 모든 도시의 성장률이 +25% 증가합니다.[NEWLINE][ICON_BULLET]현재 소유한 [ICON_GREAT_WORK]걸작 1개마다 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] 증가합니다.[COLOR:105:105:105:255](한도: 20%)[ENDCOLOR]'
