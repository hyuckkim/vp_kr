...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]국제 연합[ENDCOLOR]이 건설되고 [ICON_BULLET][COLOR_POSITIVE_TEXT]세계 이념 결의안[ENDCOLOR]이 활성화된 경우 교차 회기에 [COLOR_POSITIVE_TEXT]세계 패권[ENDCOLOR] 제안'
