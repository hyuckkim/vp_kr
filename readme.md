...
[Vox Populi 인스톨러 받기](https://github.com/LoneGazebo/Community-Patch-DLL/releases/download/Release-3.9.1/Vox.Populi.3.9.1.exe)  
[한글 패치 인스톨러 받기](https://github.com/hyuckkim/vp_kr/releases/download/v3.9.1/Vox.Populi.INT.3.9.1.exe)  
