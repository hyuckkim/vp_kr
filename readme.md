...
[Vox Populi 인스톨러 받기](https://github.com/LoneGazebo/Community-Patch-DLL/releases/download/Release-4.2.5/Vox.Populi.4.2.5.exe)  
[한글 패치 인스톨러 받기](https://github.com/hyuckkim/vp_kr/releases/download/v4.2.5b/Vox.Populi.INT.4.2.5.exe) / [(또는 자동 릴리즈된 Nightly 인스톨러 받기)](https://nightly.link/hyuckkim/vp_kr/workflows/inno-build/master/vox%20populi%20kor.zip)
