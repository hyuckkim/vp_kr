...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문화유산[ENDCOLOR][NEWLINE]세계 불가사의 또는 국가 불가사의 건설을 완료하면 황금기 점수를 [COLOR_POSITIVE_TEXT]200[ENDCOLOR] [COLOR:105:105:105:255](시대별 보정)[ENDCOLOR] 제공합니다. 모든 대학의 [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]6[ENDCOLOR], [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.'
