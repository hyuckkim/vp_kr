...
UPDATE Language_ko_KR
SET Text = '고전 시대 이후 매 시대마다 이 자연 경관의 [ICON_RESEARCH]과학이 증가합니다.[NEWLINE][NEWLINE]배린저 운석공는 미국 아리조나에 있는 거대한 운석 충돌 분화구로 지름이 1,200m입니다. 5만년 전 160,000톤 짜리 니켈-철 운석이 충돌 당시 초속 약 20km의 속도로 충돌하여 생긴 분화구라고 알려져 있습니다.'
...
UPDATE Language_ko_KR
SET Text = '고전 시대 이후 매 시대마다 이 자연 경관의 [ICON_CULTURE]문화가 증가합니다.[NEWLINE][NEWLINE]후지산은 일본에서 가장 높은 산이면서 현재 활화산입니다. 높이 3,776m의 정상은 종종 구름에 둘러 쌓여 도쿄에서 볼 수 있는 바로 그 유명한 눈덮힌 실루엣을 연출합니다. 후지산의 위엄은 셀 수 없는 시, 곡, 사진, 조각, 회화의 소재가 되었으며 일본의 자존심과 아름다움의 상징이 되었습니다.'
...
UPDATE Language_ko_KR
SET Text = '고전 시대 이후 매 시대마다 이 자연 경관의 [ICON_FOOD]식량이 증가합니다.[NEWLINE][NEWLINE]그랜드 메사는 미국 콜로라도에 있는 거대한 지형으로 주변 환경 위로 1,500m 높이로 솟아 오른 1,300km2 면적의 지역으로 메사 지형 중 세계 최대 크기입니다. 그랜드 메사의 상층부에는 현무암 지층이 있어서 부식을 막아줍니다. 원래 지금처럼 높지 않았지만, 현무암 지층이 있는 부분은 더이상 침식되지 않고 주변 지형만 콜로라도와 거니슨 강의 영향으로 침식되어 메사 지형을 형성하게 되었습니다.'
...
UPDATE Language_ko_KR
SET Text = '고전 시대 이후 매 시대마다 이 자연 경관의 [ICON_RESEARCH]과학이 증가합니다.[NEWLINE][NEWLINE]대보초는 세계에서 가장 큰 암초입니다. 호주 남해에 위치하여 거의 3,000개의 암초와 1,000개의 섬이 연결되어 길이가 약 2,000km에 이릅니다. 50만년보다도 더 이전에 수많은 산호충으로 형성되기 시작하여 현존하는 단일 생명체의 구조로는 세계에서 가장 큽니다. 대보초는 셀 수 없이 많은 다양한 고래, 돌고래, 거북이, 물고기, 문어, 뱀은 물론 200종이 넘는 새들의 서식지입니다.'
...
UPDATE Language_ko_KR
SET Text = '고전 시대 이후 매 시대마다 이 자연 경관의 [ICON_RESEARCH]과학이 증가합니다.[NEWLINE][NEWLINE]크라카타우는 인도네시아의 자바 섬과 수마트라 섬 사이에 위치한 화산섬입니다. 1883년 8월 히로시마에 투하된 원폭의 13000배의 파괴력을 가진 화산이 폭발하여 섬의 절반을 쓸어버렸습니다. 이때의 폭발음이 3,500km 떨어진 호주에서도 들렸다고 합니다. 화산 폭발과 뒤를 이은 해일로 인해 37,000명 가량의 사람들이 목숨을 잃었습니다. 지난 8년간 화산은 꾸준히 용암을 뱉어내고 있으며 연간 약 4.6m 정도의 속도로 다시 쌓이고 있습니다.'
...
UPDATE Language_ko_KR
SET Text = '고전 시대 이후 매 시대마다 이 자연 경관의 [ICON_FOOD]식량이 증가합니다.[NEWLINE][NEWLINE]스리랑카에 우뚝 솟은 스리파다는 특이한 원뿔 모양을 한 봉우리로 많은 종교에서 이곳 정상에 있는 "발자국"을 신성시합니다. 산 정상에 있는 바위에 움푹 박힌 이 자국은 부처, 시바 신 또는 성경에 나오는 아담의 발자국이라 불리며 수많은 불교, 힌두교, 이슬람교 신자들에게 있어 숭배의 대상입니다. 매년 수천 명의 순례자가 이 발자국을 경배하러 찾아옵니다.'
...
UPDATE Language_ko_KR
SET Text = '고전 시대 이후 매 시대마다 이 자연 경관의 [ICON_PEACE]신앙이 증가합니다.[NEWLINE][NEWLINE]이집트의 시나이 반도에 있는 시나이산은 유대교, 기독교, 이슬람교의 성지 중 제일 많이 숭배되는 곳 중 하나입니다. 유대 민족이 이집트를 탈출했을 때 모세가 신에게서 처음 십계명을 받은 곳이 바로 이곳이라고 믿는 순례자들이 세계 각지에서 이곳을 찾아옵니다.'
...
UPDATE Language_ko_KR
SET Text = '고전 시대 이후 매 시대마다 이 자연 경관의 [ICON_PEACE]신앙이 증가합니다.[NEWLINE][NEWLINE]티벳 히말라야 산맥의 성스러운 카일라스 산은 힌두교를 비롯한 수많은 종교에서 신성시하는 곳입니다. 이곳은 산속에서 영원한 행복에 싸여 살아간다는 시바 신의 거처로 믿어져 왔습니다. 카일라스 산은 순례하기 제일 어려운 곳 중 하나로 가혹한 환경에 무릎 꿇은 순례자 지망생들이 부지기수이며 어떠한 현대 교통수단으로도 오를 수 없는 산이기도 합니다.'
...
UPDATE Language_ko_KR
SET Text = '고전 시대 이후 매 시대마다 이 자연 경관의 [ICON_PRODUCTION]생산이 증가합니다.[NEWLINE][NEWLINE]흔히 "에어즈록"이라고 하는 호주 중앙부의 거대한 적색 사암은 지난 수세기에 걸쳐 호주에서 제일 유명한 지형물로 자리매김 했습니다. 1800년대 후반에 영국 탐험가들이 발견하기 전까지 이 산은 원주민들이 붙인 "울루루"라는 이름으로 불렸습니다. 원주민들은 울루루의 탄생과 그 중요성에 대한 다양한 전설을 남겼다. 1987년 유네스코의 세계 유산으로 지정된 후 관광지로써 인기가 폭증해 매년 수만 명의 관광객이 이곳을 찾고 있습니다.'
...
UPDATE Language_ko_KR
SET Text = '고전 시대 이후 매 시대마다 이 자연 경관의 [ICON_CULTURE]문화가 증가합니다.[NEWLINE][NEWLINE]이 전설적인 "잃어버린 황금 도시"는 일확천금을 꿈꾸는 수많은 스페인 정복자들을 신세계로 끌어들였습니다. 이 전설적인 신화는 거의 3세기에 걸쳐 탐험가들을 남아메리카 해안으로 오게 이끌었고 그들은 탐험 도중에 만난 많은 도시를 약탈했습니다. 엘도라도는 계속하여 사람들을 매혹했고 1804년에는 이 위치를 알아내기 위해 탐험단이 구성되었습니다. 그러나 오늘날에는 이 전설적인 도시가 무이스카 사제가 종교의식의 일종으로 온몸을 금으로 덮은 다음 과타비타 호수로 뛰어든 일화에 의해 유래되었다고 전해집니다.'
