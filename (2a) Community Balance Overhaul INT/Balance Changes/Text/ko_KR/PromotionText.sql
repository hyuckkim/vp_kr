...
UPDATE Language_ko_KR
SET Text = '평지 전투 보너스 (30)'
WHERE Tag = 'TXT_KEY_PROMOTION_OPEN_TERRAIN';

INSERT INTO Language_ko_KR (Tag, Text)
VALUES ('TXT_KEY_PROMOTION_OPEN_TERRAIN_HELP', '평지에서 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+30%[ENDCOLOR].');
...
-- fixed Ranged Support Fire
	UPDATE Language_ko_KR
	SET Text = '[COLOR_POSITIVE_TEXT]유닛[ENDCOLOR]을 공격하기 전에, 50%의 [ICON_STRENGTH]전투력으로 [COLOR_POSITIVE_TEXT]원거리 공격[ENDCOLOR]을 수행합니다. [COLOR_NEGATIVE_TEXT]요새화할 수 없습니다.[ENDCOLOR][NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]업그레이드 시 소멸[ENDCOLOR]'
	WHERE Tag = 'TXT_KEY_PROMOTION_RANGED_SUPPORT_FIRE_HELP';

-- fixed spear throw
UPDATE Language_ko_KR
SET Text = '화약 유닛 대항 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+25%[ENDCOLOR][NEWLINE]공격 전 50% [ICON_STRENGTH] 전투력으로 추가 원거리 공격. [COLOR_NEGATIVE_TEXT]요새화할 수 없습니다.[ENDCOLOR][NEWLINE][COLOR_NEGATIVE_TEXT]업그레이드 시 소멸[ENDCOLOR]'
...
UPDATE Language_ko_KR
SET Text = '해상 및 지상 유닛 대항 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+10%[ENDCOLOR]'
...
-- Bomber Siege
UPDATE Language_ko_KR
SET Text = '도시 공격 시 [ICON_RANGE_STRENGTH]원거리 전투력 [COLOR_POSITIVE_TEXT]+50%[ENDCOLOR]'
...
UPDATE Language_ko_KR
SET Text = '턴마다 [COLOR_POSITIVE_TEXT]두 번[ENDCOLOR] 공격 가능. 공격 후 이동 가능.'
...
'적 공중 유닛 요격 확률 [COLOR_POSITIVE_TEXT]+15%[ENDCOLOR]');
