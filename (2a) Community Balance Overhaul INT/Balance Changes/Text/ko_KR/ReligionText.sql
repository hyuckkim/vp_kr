...
-- Peace Loving (Now Devine Inheritance)
UPDATE Language_ko_KR
SET Text = '[ICON_GOLDEN_AGE]황금기 동안 성도의 산출량이 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 증가합니다. [NEWLINE][COLOR_YELLOW]천상의 옥좌[ENDCOLOR] 국가 불가사의를 건설할 수 있습니다.(+2 [ICON_PEACE] 신앙, [ICON_CULTURE] 문화, [ICON_FOOD] 식량, [ICON_RESEARCH] 과학, [ICON_GOLD] 골드, [ICON_PRODUCTION] 생산; [ICON_RELIGION]성지에서  +5 [ICON_PEACE] 신앙; [COLOR_POSITIVE_TEXT개혁 교리[ENDCOLOR]를 선택할 수 있습니다.)'
...
-- Ceremonial Burial
UPDATE Language_ko_KR
SET Text = ' [ICON_GREAT_PEOPLE]위인을 소모할 때 당신의 [ICON_RELIGION]종교를 따르는 도시에 [COLOR:110:110:110:255](한도: 25도시)[ENDCOLOR] [ICON_PEACE]신앙 및 [ICON_CULTURE]문화를 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] 제공합니다. (시대에 따라 보정) [NEWLINE][COLOR_YELLOW]마우솔레움[ENDCOLOR] 국가 불가사의를 건설할 수 있습니다. (+5 [ICON_PEACE] 신앙, 적 유닛을 처치할 때 [ICON_PEACE] 신앙, [ICON_RELIGION]성지에서  +5 [ICON_PEACE] 신앙; [COLOR_POSITIVE_TEXT개혁 교리[ENDCOLOR]를 선택할 수 있습니다.)'
...
UPDATE Language_ko_KR
SET Text = '정책을 채택할 때 당신 문명의 [ICON_RELIGION]종교를 따르는 신도 1명마다 [COLOR:110:110:110:255](한도: 250명)[ENDCOLOR] [ICON_PEACE]신앙, [ICON_RESEARCH]과학, [ICON_GOLD]골드를 [COLOR_POSITIVE_TEXT]5[ENDCOLOR] 제공합니다. [NEWLINE][COLOR_YELLOW]성스러운 법정[ENDCOLOR] 국가 불가사의를 건설할 수 있습니다. (+4 [ICON_PEACE] 신앙, +6 [ICON_GOLD] 골드;  [ICON_RELIGION]성지에서 +5 [ICON_GOLD] 골드; [COLOR_POSITIVE_TEXT개혁 교리[ENDCOLOR]를 선택할 수 있습니다.)'
...
UPDATE Language_ko_KR
SET Text = '당신 문명의 종교를 처음 채택한 도시는 [COLOR:110:110:110:255](한도: 25도시)[ENDCOLOR] 당신의 성도에 [ICON_RESEARCH]과학 및 [ICON_PRODUCTION]생산을 [COLOR_POSITIVE_TEXT]20[ENDCOLOR] [COLOR:110:110:110:255](종교를 따르는 도시의 수에 따라 보정)[ENDCOLOR] 제공합니다. [NEWLINE][COLOR_YELLOW]종교 공의회[ENDCOLOR] 국가 불가사의를 건설할 수 있습니다. (+4 [ICON_PEACE] 신앙, +5 [ICON_FOOD] 식량;  [ICON_RELIGION]성지에서 +5 [ICON_RESEARCH] 과학; [COLOR_POSITIVE_TEXT개혁 교리[ENDCOLOR]를 선택할 수 있습니다.)'
...
UPDATE Language_ko_KR
SET Text = '[ICON_RELIGION]종교 전파 시 +20 [ICON_FOOD]식량을 성도에 제공합니다. (새로운 신도 수에 따라 보정) 새로운 [ICON_RESEARCH]기술을 연구하면, [ICON_RELIGION]종교의 신도마다 2 [ICON_PEACE]신앙을 제공합니다. (한도: 250명) [NEWLINE][COLOR_POSITIVE_TEXT]사도 궁전 [ENDCOLOR] 불가사의를 건설할 수 있습니다. (+4 [ICON_PEACE] 신앙, +4 [ICON_GOLDEN_AGE] 황금기 점수;  [ICON_RELIGION]성지에서 +5 [ICON_GOLDEN_AGE] 황금기 점수; [COLOR_POSITIVE_TEXT개혁 교리[ENDCOLOR]를 선택할 수 있습니다.)'
...
UPDATE Language_ko_KR
SET Text = '"국왕 경축일"이 열리는 동안 [ICON_PEACE]신앙, [ICON_CULTURE]문화, [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다. [NEWLINE][COLOR_YELLOW]대 납골당[ENDCOLOR] 국가 불가사의를 건설할 수 있습니다. (+10 [ICON_PEACE] 신앙;  [ICON_RELIGION]성지에서 +5 [ICON_CULTURE] 문화; [COLOR_POSITIVE_TEXT개혁 교리[ENDCOLOR]를 선택할 수 있습니다.)'
